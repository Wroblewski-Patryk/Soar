...
const manifest = (overrides = {}) => ({
  ...
  sourceChain: {
    ...
    remediationPlan: 'history/audits/audit-remediation-master-plan-2026-05-19.md',
    remediationPlanJson: 'history/artifacts/audit-remediation-master-plan-2026-05-19.json',
  ...
  openDecisions: [
    {
      id: 'DEC-AUD-001',
      packet: 'history/audits/audit-decision-packet-2026-05-19.md',
      playbook: 'history/audits/audit-decision-repair-playbooks-2026-05-19.md',
    },
  ],
  ...overrides,
});
