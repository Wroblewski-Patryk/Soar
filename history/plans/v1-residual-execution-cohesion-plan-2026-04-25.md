...
In [orders.service.ts](../../apps/api/src/modules/orders/orders.service.ts:119),
...
Later, [openOrder()](../../apps/api/src/modules/orders/orders.service.ts:479)
...
In [orders.manualContext.service.ts](../../apps/api/src/modules/orders/orders.manualContext.service.ts:184),
...
submission in [orders.service.ts](../../apps/api/src/modules/orders/orders.service.ts:479).
...
In [orders.service.ts](../../apps/api/src/modules/orders/orders.service.ts:533),
...
[livePositionReconciliation.service.ts](../../apps/api/src/modules/positions/livePositionReconciliation.service.ts:404),
...
[runtimeBotExecutionContext.ts](../../apps/api/src/modules/engine/runtimeBotExecutionContext.ts:1)
...
In [useManualOrderController.ts](../../apps/web/src/features/dashboard-home/hooks/useManualOrderController.ts:118),
