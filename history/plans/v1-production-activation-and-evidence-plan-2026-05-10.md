# V1 Production Activation And Evidence Plan (2026-05-10)
...
- Public production Web build-info exposes
  `74752f025ef49bf5026ec92e056f59947e00a18f`, the current RC blocked-evidence
  refresh batch.
...
- The no-secret V1 final preflight for 2026-05-10 reports public deploy health
...
## Scope
- Production activation evidence planning for 2026-05-10.
...
2. Run the canonical `LIVEIMPORT-03` collector against production after
   ...
   `node scripts/waitForWebBuildInfo.mjs --web-base-url https://soar.luckysparrow.ch --expected-sha 74752f025ef49bf5026ec92e056f59947e00a18f --timeout-seconds 900 --interval-seconds 30`
   then
   `pnpm run ops:liveimport:readback -- --expected-sha 74752f025ef49bf5026ec92e056f59947e00a18f --output docs/operations/liveimport-03-prod-readback-2026-05-10.json`.
...
- Required production evidence artifacts are fresh for 2026-05-10.
...
## Definition Of Done
- `pnpm run ops:release:v1:gate -- --environment prod --base-url https://api.soar.luckysparrow.ch --web-base-url https://soar.luckysparrow.ch --expected-sha 74752f025ef49bf5026ec92e056f59947e00a18f --skip-local-quality` returns `ready`.
...
- Reason:
  ...
  - production DB restore context is missing for a 2026-05-10 restore refresh
  - rollback guard auth is missing
  - RC sign-off record is blocked until real approver identities are provided
  - RC external gates status, sign-off, and checklist are fresh for 2026-05-10
    but failed/open
