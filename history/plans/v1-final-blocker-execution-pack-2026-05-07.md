...
`history/evidence/v1-rollback-proof-prod-2026-05-10T00-00-00-000Z.md` because
...
- Current verified deployed candidate is
  ...
  `history/releases/v1-final-preflight-fd8da90b-2026-05-10.md` and is correctly
