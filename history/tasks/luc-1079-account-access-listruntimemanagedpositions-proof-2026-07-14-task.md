# LUC-1079 Account Access listRuntimeManagedPositions Proof

## Header
- ID: LUC-1079
- Title: Account access `listRuntimeManagedPositions` missing-test-link proof
- Task Type: fix
...
- Depends on: none
- Priority: P1
- Module Confidence Rows: Account access / API bots runtime managed-position list repository helper executable proof
- Requirement Rows: not applicable
- Quality Scenario Rows: not applicable
- Risk Rows: app-completion missing-test-link routing for Account access runtime managed-position list repository helper
- Iteration: 1
- Operation Mode: BUILDER
- Mission ID: LUC-1079-ACCOUNT-ACCESS-LISTRUNTIMEMANAGEDPOSITIONS-PROOF-2026-07-14
- Mission Status: VERIFIED

## Context

`LUC-1079` was dispatched from the Account access app-completion queue to close
...
Close the missing-test-link lane for `listRuntimeManagedPositions` with the
...
- Task summary:
  - added a focused repository proof in
    `listRuntimeManagedPositions.repository.test.ts`, linked the helper
