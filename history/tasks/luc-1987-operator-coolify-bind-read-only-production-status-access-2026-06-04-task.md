# LUC-1987 Task Contract - Coolify Read-Only Production Status Access
...
[LUC-1987](/LUC/issues/LUC-1987) asked to bind or validate read-only Coolify
...
- Coolify readback at `2026-06-04T13:47:00Z` resolved project `Soar`,
...
- Application inventory status remains `running:unknown`; PostgreSQL reports
  `running:healthy`; Redis reports `running:unknown`.
...
readiness, Redis health, database health beyond inventory status, and protected
worker readiness still require separate release smoke or a release mutation
