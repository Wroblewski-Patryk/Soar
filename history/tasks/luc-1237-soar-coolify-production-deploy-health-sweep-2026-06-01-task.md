# LUC-1237 - [Soar] Coolify production deploy health sweep (2026-06-01)

## Context
Critical Ops Release Lead heartbeat requiring fresh production deploy-health truth for canonical Soar hosts.
