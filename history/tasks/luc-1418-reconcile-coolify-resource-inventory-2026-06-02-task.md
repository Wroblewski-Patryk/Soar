...
- Mission ID: LUC-1418-COOLIFY-RESOURCE-INVENTORY-RECONCILIATION-2026-06-02
...
## Mission Block
- Mission objective: verify and record the Soar production Coolify resource inventory for LUC-1418.
...
- `history/tasks/luc-1418-reconcile-coolify-resource-inventory-2026-06-02-task.md`
...
- Manual checks:
  ...
  - Retry heartbeat read-only projection captured at `2026-06-02T05:19:13Z`.
...
- Files changed: ops docs, state files, evidence/task packets.
