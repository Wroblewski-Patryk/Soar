# LUC-1831 Operator Coolify Read-Only Production Status Access
...
- Mission ID: `LUC-1831-COOLIFY-READ-ONLY-PRODUCTION-STATUS-ACCESS-2026-06-03`
- Mission Status: VERIFIED

## Context

Paperclip assigned [LUC-1831](/LUC/issues/LUC-1831) to Ops Release Lead to bind
...
- Paperclip issue context for [LUC-1831](/LUC/issues/LUC-1831).
...
- Manual checks:
  ...
  - `GET /api/v1/resources` - PASS, `17` visible rows and `8`
...
- [LUC-1831](/LUC/issues/LUC-1831) was `in_progress`, critical, and had zero
  first-class blockers.
- Active mission already contained prior Coolify read-only checkpoints
  [LUC-1822](/LUC/issues/LUC-1822) and [LUC-1828](/LUC/issues/LUC-1828).

### 2. Select One Priority Mission Objective

- Selected task: verify [LUC-1831](/LUC/issues/LUC-1831) read-only production
  status access.
...
- Task summary: verified [LUC-1831](/LUC/issues/LUC-1831) Coolify read-only
