# LUC-1997 Task Contract - Coolify Read-Only Production Status Access
...
[LUC-1997](/LUC/issues/LUC-1997) asked to bind or validate read-only Coolify
...
- Coolify readback at `2026-06-04T14:46:54Z` resolved project `Soar`,
...
- Paperclip heartbeat context returned the scoped issue as `in_progress`,
  priority `critical`, with zero first-class blockers and one recent comment.
