...
- Depends on: `history/plans/luc-384-architecture-repair-backlog-2026-05-28.md`, `history/plans/luc-408-architecture-repair-backlog-execution-map-2026-05-28.md`, `history/plans/luc-508-architecture-repair-backlog-control-map-2026-05-28.md`, `history/plans/luc-583-architecture-repair-backlog-control-map-2026-05-29.md`, `history/plans/luc-616-arb-001-activation-scope-decision-2026-05-29.md`
- Priority: high
...
## Definition of Done
- [x] Current control map exists for `LUC-705` with all `ARB-001..ARB-008` rows.
...
2. Publish refreshed `LUC-705` control map artifact.
3. Synchronize source-of-truth context files with final disposition and blockers.

## Acceptance Criteria
- `history/plans/luc-705-architecture-repair-backlog-control-map-2026-05-29.md` exists and references canonical backlog/execution artifacts.
- Control map reflects `DEC-ARB-001` and `DEC-ARB-002` as decision-gated rows and keeps `ARB-006` as the active blocker.
- `TASK_BOARD` and `PROJECT_STATE` record `LUC-705` as `done` planning lane.

## Validation Evidence
- `rg -n "LUC-705|DEC-ARB-001|DEC-ARB-002|ARB-006|control_map_refreshed" history/plans/luc-705-architecture-repair-backlog-control-map-2026-05-29.md history/tasks/luc-705-architecture-docs-executable-repair-backlog-2026-05-29-task.md .codex/context/TASK_BOARD.md .codex/context/PROJECT_STATE.md`

## Result Report
- Task summary: refreshed architecture-repair backlog PM control truth for 2026-05-29 with current decision gates and active blocker routing.
- Files changed:
