...
- Manual checks: rendered auth smoke PASS for SSR `/auth/register` and
  ...
  `/dashboard`.
- Screenshots/logs:
  - `history/artifacts/_artifacts-v1ui30-auth-smoke/register-desktop-dashboard.png`
  - `history/artifacts/_artifacts-v1ui30-auth-smoke/login-mobile-dashboard.png`
  - `history/artifacts/_artifacts-v1ui30-auth-smoke/report.json`
