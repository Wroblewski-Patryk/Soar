...
## Context
`LUC-1531` asks Ops to confirm the expected Coolify team/workspace selector so
...
## Scope
- Paperclip issue context for `LUC-1531`.
...
- Files changed: this task packet, this evidence packet, operations deployment contract, runtime config ledger, project state, task board.
