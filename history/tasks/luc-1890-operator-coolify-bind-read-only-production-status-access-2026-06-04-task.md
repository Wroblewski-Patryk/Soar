...
- Mission ID: LUC-1890-COOLIFY-READ-ONLY-PRODUCTION-STATUS-ACCESS-2026-06-04
...
- Issue: `LUC-1890` in progress, critical, no blockers.
...
### 6. Self-Review
- Simpler option considered: relying on `LUC-1885` evidence only; rejected
