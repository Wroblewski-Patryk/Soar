# LUC-1098 Account Access listRuntimePositionTradeRows Doc-Link Closure

## Context

- ID: `LUC-1098`
- Title: Account access `listRuntimePositionTradeRows` missing-doc-link closure
- Task Type: `fix`
...
[LUC-1096](/LUC/issues/LUC-1096) closed the helper's focused repository proof.

## Goal

Attach durable module documentation and canonical graph relations for
`listRuntimePositionTradeRows` so generated app-completion and project-truth
...
- Readback:
  `listRuntimePositionTradeRows` is no longer a docs-owned first gap. The
...
- Residual:
  direct proof remains owned by [LUC-1096](/LUC/issues/LUC-1096), and the
