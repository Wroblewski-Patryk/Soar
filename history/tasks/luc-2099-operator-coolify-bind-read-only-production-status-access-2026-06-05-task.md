# LUC-2099 Operator Coolify Bind Read-Only Production Status Access
...
Paperclip wake payload assigned [LUC-2099](/LUC/issues/LUC-2099) as a critical
...
Fresh read-only Coolify readback at `2026-06-05T06:52:51Z` confirmed required
binding names are present without value disclosure, configured project `Soar`,
production environment `production`, six application resources, PostgreSQL,
Redis, zero generic services, and `17` visible global resource rows.
