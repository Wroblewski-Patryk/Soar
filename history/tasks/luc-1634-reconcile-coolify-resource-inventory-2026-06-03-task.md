...
- Mission ID: `LUC-1634-COOLIFY-RESOURCE-INVENTORY-RECONCILIATION-2026-06-03`
...
1. Read the Paperclip heartbeat context for `LUC-1634`.
...
- `GET /api/issues/LUC-1634/heartbeat-context` -> pass; issue was
  `in_progress`, priority `critical`, zero first-class blockers.
- `GET /api/v1/teams/current` -> pass at `2026-06-03T02:03:30Z`, current
