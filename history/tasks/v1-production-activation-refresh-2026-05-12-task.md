...
- Manual checks:
  - `history/audits/v1-production-activation-evidence-audit-2026-05-12.md` exists and reports `NO-GO`.
  - `history/plans/v1-production-activation-and-evidence-plan-2026-05-12.md` exists and reports `NO-GO`.
...
- Docs updated:
  ...
  - `history/artifacts/_artifacts-v1-release-gate-prod-2026-05-12Tactivation-refresh-dry-run.json`
