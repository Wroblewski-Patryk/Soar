# LUC-1096 Account Access listRuntimePositionTradeRows Proof

## Header
- ID: LUC-1096
- Title: Account access `listRuntimePositionTradeRows` missing-test-link proof
- Task Type: fix
...
- Depends on: none
- Priority: P1
- Module Confidence Rows: Account access / API bots runtime position trade-row repository helper executable proof
- Requirement Rows: not applicable
- Quality Scenario Rows: not applicable
- Risk Rows: app-completion missing-test-link routing for Account access runtime position trade-row repository helper
- Iteration: 1
- Operation Mode: BUILDER
- Mission ID: LUC-1096-ACCOUNT-ACCESS-LISTRUNTIMEPOSITIONTRADEROWS-PROOF-2026-07-14
- Mission Status: VERIFIED

## Context

`LUC-1096` was dispatched from the Account access app-completion queue to close
...
Close the missing-test-link lane for `listRuntimePositionTradeRows` with the
...
- Tests:
  - `corepack pnpm --filter api exec vitest run src/modules/bots/listRuntimePositionTradeRows.repository.test.ts --run --reporter=dot`
- Source truth:
...
- Task summary:
  - added a focused repository proof in
    `listRuntimePositionTradeRows.repository.test.ts`, linked the helper
