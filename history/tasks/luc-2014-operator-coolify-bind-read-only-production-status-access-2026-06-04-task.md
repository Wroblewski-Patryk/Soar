# LUC-2014 Task Contract - Coolify Read-Only Production Status Access
...
[LUC-2014](/LUC/issues/LUC-2014) asked to bind or validate read-only Coolify
...
- Coolify readback at `2026-06-04T16:46:41Z` resolved project `Soar`,
...
- Wake payload scoped this heartbeat to [LUC-2014](/LUC/issues/LUC-2014),
  status `in_progress`, priority `critical`, with no pending comments and
  `fallbackFetchNeeded=false`.
- Initial local PowerShell projection attempt failed before network access
  because `??` null-coalescing syntax is unsupported in this runtime; rerun
  with compatible syntax succeeded and printed no secret values.
