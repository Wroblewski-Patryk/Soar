...
## Context
`LUC-1518` asks Ops to confirm the expected Coolify team/workspace selector so
...
- Selected task: confirm Coolify team/workspace for `LUC-1518`.
- Priority rationale: high-priority issue assigned to Ops.
- Why other candidates were deferred: wake payload scoped this heartbeat to `LUC-1518`.
