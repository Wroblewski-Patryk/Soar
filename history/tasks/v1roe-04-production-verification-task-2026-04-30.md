...
- Screenshots/logs: `history/plans/v1roe-04-prod-verification-closure-2026-05-01.md`
...
- Architecture source reviewed: `docs/architecture/reference/live-protection-state-parity-contract.md`,
  ...
  `history/audits/v1roe-live-pnl-roe-and-runtime-automation-parity-plan-2026-04-30.md`
