# LUC-2251 Operator Coolify Bind Read-Only Production Status Access

Date: 2026-06-05
Stage: verification
Owner: Ops Release Lead
Issue: [LUC-2251](/LUC/issues/LUC-2251)

## Context

Paperclip wake payload assigned [LUC-2251](/LUC/issues/LUC-2251) as a critical
...
1. Consume the scoped wake for [LUC-2251](/LUC/issues/LUC-2251).
...
Fresh read-only Coolify readback at `2026-06-05T17:52:31Z` confirmed required
