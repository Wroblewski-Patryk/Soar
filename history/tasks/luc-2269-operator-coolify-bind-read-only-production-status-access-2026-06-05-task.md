# LUC-2269 Operator Coolify Bind Read-Only Production Status Access
...
Paperclip wake payload assigned [LUC-2269](/LUC/issues/LUC-2269) as a critical
...
1. Consume the scoped wake for [LUC-2269](/LUC/issues/LUC-2269).
...
Fresh read-only Coolify readback at `2026-06-05T19:23:32Z` confirmed required
...
- `history/evidence/luc-2269-coolify-read-only-production-status-access-2026-06-05.md`
