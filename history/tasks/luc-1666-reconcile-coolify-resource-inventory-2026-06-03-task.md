...
- Mission ID: `LUC-1666-COOLIFY-RESOURCE-INVENTORY-RECONCILIATION-2026-06-03`
...
The wake payload scoped this heartbeat to `LUC-1666`. There were no pending
...
1. Read the Paperclip heartbeat context for `LUC-1666`.
...
- `GET /api/issues/LUC-1666/heartbeat-context` -> pass; issue was
...
- Names-only Paperclip and Coolify env binding check -> pass without printing
  values.
- `GET /api/v1/teams/current` -> pass at `2026-06-03T05:05:10Z`, current
