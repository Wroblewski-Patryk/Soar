...
- Mission ID: LUC-1644-COOLIFY-TEAM-WORKSPACE-CONFIRMATION-2026-06-03
...
## Scope
- Paperclip issue context: `LUC-1644`
...
## Implementation Plan
1. Read Paperclip heartbeat context for `LUC-1644`.
...
- Manual/API checks:
  - `GET /api/issues/LUC-1644/heartbeat-context` -> pass; issue read back as
