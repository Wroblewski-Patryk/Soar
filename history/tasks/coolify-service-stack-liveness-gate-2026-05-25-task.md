...
- Primary feature/module: Coolify Service Stack liveness and readiness gate.
...
- Tests/proof: liveness gate remains blocked as recorded in this task's status and blocker notes.
