...
- Mission ID: LUC-1665-COOLIFY-TEAM-WORKSPACE-CONFIRMATION-2026-06-03
...
## Scope
- Paperclip issue context: `LUC-1665`
...
- Documentation/evidence:
  ...
  - `history/tasks/luc-1665-confirm-coolify-team-workspace-2026-06-03-task.md`

## Implementation Plan
1. Read Paperclip heartbeat context for `LUC-1665`.
...
- Manual/API checks:
  - `GET /api/issues/LUC-1665/heartbeat-context` -> pass; issue read back as
    `in_progress` with zero first-class blockers.
  - Names-only env presence check -> pass.
  - `GET /api/v1/teams/current` -> pass at `2026-06-03T05:03:35Z`, selector
  ...
  - `GET /api/v1/projects/{configured-project-id}/production` -> pass,
    environment `production`, id `6`, six applications, one PostgreSQL
