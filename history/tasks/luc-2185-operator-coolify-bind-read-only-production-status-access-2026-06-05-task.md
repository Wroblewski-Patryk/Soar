# LUC-2185 Operator Coolify Bind Read-Only Production Status Access
...
Paperclip wake payload assigned [LUC-2185](/LUC/issues/LUC-2185) as a critical
...
Fresh read-only Coolify readback at `2026-06-05T11:54:26Z` confirmed required
...
- `history/evidence/luc-2185-coolify-read-only-production-status-access-2026-06-05.md`
