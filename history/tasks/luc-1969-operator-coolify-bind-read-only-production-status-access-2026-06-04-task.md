# LUC-1969 Task Contract - Coolify Read-Only Production Status Access
...
[LUC-1969](/LUC/issues/LUC-1969) asked to bind or validate read-only Coolify
...
- Coolify readback at `2026-06-04T11:47:06Z` resolved project `Soar`,
...
- Application inventory status remains `running:unknown`; PostgreSQL and Redis
  report `running:healthy` in this read.
