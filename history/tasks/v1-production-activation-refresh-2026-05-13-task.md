...
- Manual checks:
  - `history/audits/v1-production-activation-evidence-audit-2026-05-13.md` exists and reports `NO-GO`.
  - `history/plans/v1-production-activation-and-evidence-plan-2026-05-13.md` exists and reports `NO-GO`.
