# LUC-1605 Reconcile Coolify Resource Inventory - 2026-06-02
...
- Manual checks:
  - `GET /api/issues/{issue-id}/heartbeat-context` -> pass; `LUC-1605` is
    actionable with no first-class blockers.
  - names-only Coolify env binding check -> pass.
  - `GET /api/v1/teams/current` -> pass at `2026-06-02T21:52:06Z`, id `0`,
    name `LuckySparrow`.
