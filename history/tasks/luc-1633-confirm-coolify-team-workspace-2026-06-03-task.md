...
- Mission ID: LUC-1633-COOLIFY-TEAM-WORKSPACE-CONFIRMATION-2026-06-03
...
## Scope
- Paperclip issue context: `LUC-1633`
...
## Implementation Plan
1. Read Paperclip heartbeat context for `LUC-1633`.
...
- Manual/API checks:
  - `GET /api/issues/LUC-1633/heartbeat-context` -> pass.
