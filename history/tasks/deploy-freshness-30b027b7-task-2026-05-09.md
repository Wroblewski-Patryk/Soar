...
- Primary feature/module: Production deploy freshness for protected-backlog sync.
...
- Affected files: history/releases; history/artifacts; protected-backlog/source-of-truth docs listed in this task.
...
- Tests:
  ...
  - `node scripts\runV1FinalPreflight.mjs --api-base-url https://api.soar.luckysparrow.ch --web-base-url https://soar.luckysparrow.ch --expected-sha 30b027b78544f76b5b638851e8e27c98f6d22ab5 --today 2026-05-09 --json-output history\artifacts\_artifacts-v1-final-preflight-30b027b7-2026-05-09.json --markdown-output history\releases\v1-final-preflight-30b027b7-2026-05-09.md` => expected BLOCKED on protected/formal evidence after public PASS.
  - `git diff --check` => PASS.
