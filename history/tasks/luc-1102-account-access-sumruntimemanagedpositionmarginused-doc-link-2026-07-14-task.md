# LUC-1102 Account Access sumRuntimeManagedPositionMarginUsed Doc-Link Closure

## Context

- ID: `LUC-1102`
- Title: Account access `sumRuntimeManagedPositionMarginUsed` missing-doc-link closure
- Task Type: `fix`
...
[LUC-1100](/LUC/issues/LUC-1100) closed the helper's focused repository proof.

## Goal

Attach durable module documentation and canonical graph relations for
`sumRuntimeManagedPositionMarginUsed` so generated app-completion and
...
- Readback:
  `sumRuntimeManagedPositionMarginUsed` is no longer a docs-owned first gap.
...
- Residual:
  direct proof remains owned by [LUC-1100](/LUC/issues/LUC-1100), and the
