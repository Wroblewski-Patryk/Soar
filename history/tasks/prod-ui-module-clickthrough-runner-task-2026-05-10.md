...
- `package.json`
- `history/artifacts/_artifacts-prod-ui-module-clickthrough-84e7c0e0-2026-05-10.json`
...
- Tests:
  ...
  - EXPECTED BLOCKED:
    `node scripts\runProdUiModuleClickthroughAudit.mjs --web-base-url https://soar.luckysparrow.ch --api-base-url https://api.soar.luckysparrow.ch --expected-sha 84e7c0e012a571f18396556a97198dbed08aba7c --today 2026-05-10 --output-json history\artifacts\_artifacts-prod-ui-module-clickthrough-84e7c0e0-2026-05-10.json --output-md history\plans\prod-ui-module-clickthrough-84e7c0e0-2026-05-10.md`
