...
- Mission ID: LUC-1636-COOLIFY-TEAM-WORKSPACE-CONFIRMATION-2026-06-03
...
## Scope
- Paperclip issue context: `LUC-1636`
...
## Implementation Plan
1. Read Paperclip heartbeat context for `LUC-1636`.
...
- Manual/API checks:
  - `GET /api/issues/LUC-1636/heartbeat-context` -> pass.
