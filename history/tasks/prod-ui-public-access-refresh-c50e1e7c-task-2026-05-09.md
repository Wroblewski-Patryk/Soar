...
## Header
- ID: PROD-UI-PUBLIC-ACCESS-REFRESH-C50E1E7C-2026-05-09
- Title: Refresh public production UI access evidence for deployed c50e1e7c
- Task Type: release
...
`c50e1e7cf1e37d9c799031cacbb30a834f57e81d`. The deploy smoke covers API
...
- `history/artifacts/_artifacts-prod-ui-public-access-clickthrough-c50e1e7c-2026-05-09.json`
...
2. Confirm `/api/build-info` reports `c50e1e7c`.
...
## Acceptance Criteria
- [x] `/api/build-info` reports `c50e1e7cf1e37d9c799031cacbb30a834f57e81d`.
...
- Design source reference:
  `history/audits/prod-ui-module-clickthrough-audit-plan-2026-05-08.md`
- Canonical visual target: production UI at `c50e1e7c`
...
- Issues: deploy smoke and final preflight were current for `c50e1e7c`, but
  public route access evidence still referenced `6c54bb5d`.
