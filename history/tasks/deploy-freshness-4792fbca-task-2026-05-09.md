...
- Primary feature/module: Production deploy freshness for V1 evidence batch.
...
- Affected files: history/releases; history/artifacts; V1 evidence state files listed in this task.
