# LUC-2171 Operator Coolify Bind Read-Only Production Status Access
...
Paperclip wake payload assigned [LUC-2171](/LUC/issues/LUC-2171) as a critical
...
Fresh read-only Coolify readback at `2026-06-05T10:35:32Z` confirmed required
...
- `history/evidence/luc-2171-coolify-read-only-production-status-access-2026-06-05.md`
