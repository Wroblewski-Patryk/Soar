...
| Activation execution plan | `history/plans/v1-production-activation-and-evidence-plan-2026-04-22.md` | fresh | Canonical grouped queue exists. |
...
| Stage rehearsal evidence | `history/plans/opv-01-vps-rehearsal-2026-04-19.md` | stale, environment-specific | Useful baseline, but older than current runtime/readiness hardening. Needs fresh stage rehearsal. |
| Production gate/evidence refresh | `history/releases/opv-03-rc-gates-refresh-2026-04-19.md` | stale | Historical closure snapshot only. |
| Production closure sync | `history/plans/opv-04-closure-sync-2026-04-19.md` | stale | Historical closure sync only. |
...
| Backup/restore proof | `history/evidence/v1-db-restore-check-2026-04-09T19-32-32-768Z.md`, `history/evidence/v1-restore-drill-local-2026-04-09T19-32-34-979Z.md` | stale, environment-specific | Exists, but old and primarily local/profile-based. Needs current activation-quality proof. |
| SLO / queue-lag evidence | `history/evidence/v1-slo-window-report-7d-2026-04-19T01-36-24-775Z.md`, `history/evidence/v1-slo-window-report-30d-2026-04-19T01-36-25-355Z.md` | stale | Pre-`REVIEW-D` and not yet refreshed under current activation wave. |
