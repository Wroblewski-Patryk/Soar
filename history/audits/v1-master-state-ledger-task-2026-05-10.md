...
- `history/audits/v1-master-state-ledger-2026-05-10.md` exists.
- `history/artifacts/v1-master-state-ledger-2026-05-10.json` exists.
...
- `history/artifacts/v1-master-state-ledger-2026-05-10.json`
