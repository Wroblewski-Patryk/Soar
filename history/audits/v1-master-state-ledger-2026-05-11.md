...
Generated at: 2026-05-11T17:32:51.067Z
...
- Static issue scan: `history/artifacts/v1-static-issue-scan-2026-05-11.json`
- Product action matrix: `history/audits/v1-product-action-audit-matrix-2026-05-10.md`

## Executive Summary

- V1 status: `NO-GO`
- Matrix counts: {"PASS_LOCAL":18,"BLOCKED_AUTH":2,"UNVERIFIED":1}
- Findings by severity: {"P1":10,"P0":2,"P2":32}
- Findings by bucket: {"doneLocalNeedsProdProof":1,"toAddTests":2,"toClassifyQueue":1,"toCleanPlanning":1,"toProve":3,"toReview":1,"toReviewArchitectureOrFix":3,"toReviewCapabilityGate":29,"toReviewDocumentationOrImplement":3}
- Modules by bucket: {"doneLocalNeedsProdProof":18,"blocked":2,"toProve":1}
