...
## Validation Evidence
- Tests: `pnpm run ops:project:index -- --today 2026-05-12`; `pnpm run ops:project:scan -- --today 2026-05-12 --index history/artifacts/project-index-2026-05-12.json`; `pnpm run ops:project:ledger -- --today 2026-05-12 --index history/artifacts/project-index-2026-05-12.json --scan history/artifacts/v1-static-issue-scan-2026-05-12.json`; `pnpm run ops:project:scorecard -- --today 2026-05-12 --ledger history/artifacts/v1-master-state-ledger-2026-05-12.json` -> PASS
