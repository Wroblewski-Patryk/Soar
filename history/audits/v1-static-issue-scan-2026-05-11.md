...
Generated at: 2026-05-11T17:32:50.221Z
Evidence date: 2026-05-11
Project index: `history/artifacts/project-index-2026-05-11.json`
...
- Total findings: 44
- By severity: {"P1":10,"P0":2,"P2":32}
- By category: {"v1-proof-gap":4,"web-surface-gap":1,"web-test-gap":1,"api-test-gap":1,"web-route-gap":2,"documented-placeholder":3,"queue-hygiene":1,"queue-open-work":1,"source-capability-gate":29,"source-marker":1}
...
| P1 | queue-open-work | 10 unchecked queue markers remain | .codex/context/TASK_BOARD.md:415 - [ ] `CONTROLLED-LIVE-SESSION-PROOF-2026-05-10 release: capture guarded LIVE runtime session readback` \| .codex/context/TASK_BOARD.md:1270 - [ ] `PROD-UI-AUDIT-PLAN-2026-05-08 qa: execute production UI mod | Classify each as executable, blocked by auth/approval, or historical carryover. |
...
| P2 | queue-hygiene | Queue scan still sees unchecked `(none)` markers | .codex/context/TASK_BOARD.md:6439, .codex/context/TASK_BOARD.md:6457 | Ignore these in execution selection or change queue formatting so scan output is cleaner. |
