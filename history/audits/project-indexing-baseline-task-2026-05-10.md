...
- `history/artifacts/project-index-2026-05-10.json`
- this planning task
...
- Tests:
  ...
  - `node scripts/buildProjectIndex.mjs --today 2026-05-10` passed and wrote
    `history/plans/project-index-2026-05-10.md` plus JSON.
- Manual checks:
...
- Files changed:
  ...
  - `history/plans/project-index-2026-05-10.md`
  - `history/artifacts/project-index-2026-05-10.json`
  - `history/audits/project-indexing-baseline-task-2026-05-10.md`
- How tested:
