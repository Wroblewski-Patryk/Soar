...
- `history/artifacts/_artifacts-v1-final-preflight-fd8da90b-2026-05-10.json`
- `history/plans/prod-ui-module-clickthrough-fd8da90b-2026-05-10.md`
- `history/artifacts/_artifacts-prod-ui-module-clickthrough-fd8da90b-2026-05-10.json`
...
- Tests:
  ...
  - `node scripts\runV1FinalPreflight.mjs --web-base-url https://soar.luckysparrow.ch --api-base-url https://api.soar.luckysparrow.ch --expected-sha fd8da90bd77c2ddbed800eabd98479c1bd113ac4 --today 2026-05-10 --json-output history\artifacts\_artifacts-v1-final-preflight-fd8da90b-2026-05-10.json --markdown-output history\releases\v1-final-preflight-fd8da90b-2026-05-10.md` -> expected `BLOCKED`.
  - `node scripts\runProdUiModuleClickthroughAudit.mjs --web-base-url https://soar.luckysparrow.ch --api-base-url https://api.soar.luckysparrow.ch --expected-sha fd8da90bd77c2ddbed800eabd98479c1bd113ac4 --today 2026-05-10 --output-md history\plans\prod-ui-module-clickthrough-fd8da90b-2026-05-10.md --output-json history\artifacts\_artifacts-prod-ui-module-clickthrough-fd8da90b-2026-05-10.json` -> expected `BLOCKED_AUTH`.
