# LUC-1878 Coolify Read-Only Production Status Access Evidence
...
At `2026-06-04T02:47:18Z`, authenticated read-only Coolify API calls confirmed
...
- Issue: [LUC-1878](/LUC/issues/LUC-1878)
...
Note: an initial local PowerShell probe used the `??` operator and failed in
the runner shell before any Coolify HTTP call. The compatible probe was rerun
successfully; no secret value or raw Coolify object was printed.
