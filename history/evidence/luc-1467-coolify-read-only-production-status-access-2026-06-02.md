# LUC-1467 Coolify Read-Only Production Status Access
...
Paperclip secret metadata inspection remains board-only for this role based on
the immediately preceding access-binding checkpoint. Runtime binding and
Coolify API readback are verified; secret-store metadata was not inspected.

## Read-Only API Probes

Fresh redacted readback timestamp: `2026-06-02T08:33:39Z`.

| Probe | Result | Notes |
| --- | --- | --- |
| Paperclip heartbeat context `GET /api/issues/LUC-1467/heartbeat-context` | pass | Issue context loaded; no comments were pending. |
