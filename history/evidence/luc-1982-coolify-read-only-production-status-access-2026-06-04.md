# LUC-1982 Coolify Read-Only Production Status Access Evidence
...
At `2026-06-04T13:05:16Z`, authenticated read-only Coolify API calls confirmed
...
- Issue: [LUC-1982](/LUC/issues/LUC-1982)
...
| Coolify global resources list `GET /api/v1/resources` | pass; `1` visible row in this least-privilege runner session; not used as release authority for this checkpoint |
