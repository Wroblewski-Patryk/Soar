...
- Tests:
  ...
  - `pnpm run ops:release:v1:preflight -- --timeout-seconds 30 --interval-seconds 5 --json-output history/artifacts/_artifacts-v1-final-preflight-2026-05-08-protected-context.json --markdown-output history/releases/v1-final-preflight-2026-05-08-protected-context.md` -> expected BLOCKED.
