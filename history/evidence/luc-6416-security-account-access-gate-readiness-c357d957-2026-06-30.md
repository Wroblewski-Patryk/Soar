...
- Build-info readback time: `public Web /api/build-info not readable during LUC-6416 recheck at 2026-06-30T16:27:31Z`
...
- Status: `PARTIAL`
- Matching protected input names present: `17`
...
| --- | --- | --- | --- | --- |
| `LIVEIMPORT_READBACK_*` | no | present | 10 | Protected LIVEIMPORT-03 production runtime readback |
