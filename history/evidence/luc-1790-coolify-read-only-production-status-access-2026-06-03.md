# LUC-1790 Coolify Read-Only Production Status Access Evidence
...
At `2026-06-03T15:03:21Z`, authenticated read-only Coolify API calls confirmed
...
- Issue: [LUC-1790](/LUC/issues/LUC-1790)
- Wake reason: `issue_assigned`
- Latest comment id: none
- Fallback fetch needed: `no`
- Latest comment impact: no new comment to triage; action stayed scoped to
  read-only Coolify production-status access proof.
...
| Check | Result |
| --- | --- |
| Paperclip heartbeat context `GET /api/issues/{issueId}/heartbeat-context` | pass; [LUC-1790](/LUC/issues/LUC-1790) read as `in_progress`, priority `critical`, zero first-class blockers |
