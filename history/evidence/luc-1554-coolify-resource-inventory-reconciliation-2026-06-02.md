# LUC-1554 Coolify Resource Inventory Reconciliation Evidence
...
- Issue: `LUC-1554` `[Ops][Soar] Reconcile Coolify resource inventory`
...
- Resource ids, direct URLs, internal connection URLs, labels, server settings, and proxy settings are treated as secret-adjacent and are not recorded here.
...
Fresh redacted readback timestamp: `2026-06-02T17:04:40Z`.
