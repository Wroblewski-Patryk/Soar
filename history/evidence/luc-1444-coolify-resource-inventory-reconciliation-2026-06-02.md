# LUC-1444 Coolify Resource Inventory Reconciliation Evidence
...
- Issue: `LUC-1444` `[Ops][Soar] Reconcile Coolify resource inventory`
...
- Resource ids and internal connection URLs are treated as secret-adjacent and are not recorded here.

## Commands And Proof

| Check | Result |
| --- | --- |
| Paperclip heartbeat context `GET /api/issues/LUC-1444/heartbeat-context` | pass |
...
Fresh redacted readback timestamp: `2026-06-02T06:34:19Z`.
