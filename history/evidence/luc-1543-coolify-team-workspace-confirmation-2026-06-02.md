# LUC-1543 Coolify Team Workspace Confirmation Evidence
...
- Issue: `LUC-1543` `[Operator][Coolify] Confirm expected Coolify team/workspace`
...
| Check | Result |
| --- | --- |
| Paperclip heartbeat context `GET /api/issues/LUC-1543/heartbeat-context` | pass |
...
| Coolify production environment read `GET /api/v1/projects/{configured-project-id}/{configured-production-environment}` | pass: `6` applications, `1` PostgreSQL, `1` Redis |

Fresh redacted readback timestamp: `2026-06-02T16:08:57Z`.
