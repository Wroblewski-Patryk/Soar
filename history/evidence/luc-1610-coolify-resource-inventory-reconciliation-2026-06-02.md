# LUC-1610 Coolify Resource Inventory Reconciliation - 2026-06-02
...
Captured at `2026-06-02T22:11:28Z`.

| Probe | Result |
| --- | --- |
| `GET /api/issues/{issue-id}/heartbeat-context` | pass; issue `LUC-1610` was stale `blocked` with no first-class blockers and one duplicate-run janitor comment |
