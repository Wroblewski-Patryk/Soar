# LUC-2162 Coolify Read-Only Production Status Access Evidence
...
At `2026-06-05T10:23:19Z`, authenticated read-only Coolify API calls confirmed
...
- Issue: [LUC-2162](/LUC/issues/LUC-2162)
...
| Data-service global status projection | pass; PostgreSQL and Redis report `running:healthy` |
