# LUC-2136 Coolify Read-Only Production Status Access Evidence
...
At `2026-06-05T09:21:59Z`, authenticated read-only Coolify API calls confirmed
...
- Issue: [LUC-2136](/LUC/issues/LUC-2136)
