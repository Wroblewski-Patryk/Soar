...
- Validation:
  ...
  - `pnpm run ops:db:backup-restore:check-local` - PASS.
    - Report: `history/evidence/v1-db-restore-check-2026-05-23T13-05-22-623Z.md`.
    - Artifact: `history/artifacts/_artifacts-db-restore-check-2026-05-23T13-05-22-623Z.txt`.
- Residual risk:
