# LUC-1977 Coolify Read-Only Production Status Access Evidence
...
At `2026-06-04T12:19:30Z`, authenticated read-only Coolify API calls confirmed
...
- Issue: [LUC-1977](/LUC/issues/LUC-1977)
...
| Check | Result |
| --- | --- |
| Paperclip heartbeat context `GET /api/issues/{issueId}/heartbeat-context` | blocked by timeout before domain work; wake payload already provided scoped issue context with `fallbackFetchNeeded: no` |
