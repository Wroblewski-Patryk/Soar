# LUC-6733 Production Performance And Server Health Watch
...
- Scoped issue: [LUC-6733](/LUC/issues/LUC-6733), status `in_progress`.
- Existing restoration blocker: [LUC-6331](/LUC/issues/LUC-6331).
- Paperclip readback:
  - `/api/issues/LUC-6733/heartbeat-context` -> `200`
  - `/api/issues/LUC-6733` -> `200`
...
- Worktree: dirty before this heartbeat from existing lanes; this heartbeat
  added only scoped LUC-6733 evidence/task/state notes.
...
- worker heartbeat age: `330 ms`
- market data age: `330 ms`
...
- checked at: `2026-07-02T00:21:27.346Z`
- `shouldRollback`: `true`
...
- API `/health`: `200`, `0.112962s`
- API `/ready`: `200`, `0.105585s`
- Web `/`: `503`, `0.114651s`
- Web `/auth/login`: `503`, `0.084786s`
- Web `/api/build-info`: `503`, `0.077848s`
- API `/workers/ready` unauthenticated: `401`, `0.113678s`
