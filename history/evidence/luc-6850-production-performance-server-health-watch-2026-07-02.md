# LUC-6850 Production Performance And Server Health Watch
...
- Scoped issue: [LUC-6850](/LUC/issues/LUC-6850), status `in_progress`.
...
- Paperclip readback:
  ...
  - first-class blockers on [LUC-6850](/LUC/issues/LUC-6850): none before update
...
- Worktree: dirty before this heartbeat from existing lanes; this heartbeat
  added only scoped [LUC-6850](/LUC/issues/LUC-6850) evidence/task/state notes.
...
- worker heartbeat age: `1487 ms`
- market data age: `1487 ms`
...
- checked at: `2026-07-02T10:21:54.104Z`
- `shouldRollback`: `true`
...
- API `/health`: `200`, `0.333229s`
- API `/ready`: `200`, `0.403916s`
- Web `/`: `503`, `0.425592s`
- Web `/auth/login`: `503`, `0.349864s`
- Web `/api/build-info`: `503`, `0.342338s`
- API `/workers/ready` unauthenticated: `401`, `0.506343s`
...
- checked at: `2026-07-02T10:22:41.910Z`
- `/api/v1/version`: `200`
