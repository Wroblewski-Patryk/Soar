# LUC-1525 Coolify Team/Workspace Confirmation Evidence
...
- `GET /api/issues/LUC-1525/heartbeat-context` -> pass; issue had no
...
- `GET /api/v1/teams/current` -> pass at `2026-06-02T15:09:21Z`; current
...
- `GET /api/v1/projects/{configured-project-id}/environments` -> pass;
  environment `production` is visible.
...
`LUC-1525`. `COOLIFY_SOAR_TEAM_ID` / `COOLIFY_TEAM_ID` remain absent in this
