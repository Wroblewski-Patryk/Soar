# LUC-2117 Coolify Read-Only Production Status Access Evidence
...
At `2026-06-05T08:05:02Z`, authenticated read-only Coolify API calls confirmed
...
- Issue: [LUC-2117](/LUC/issues/LUC-2117)
