# LUC-6624 Production Performance And Server Health Watch
...
- Worktree: dirty before this heartbeat from existing product, docs, evidence,
  ...
  LUC-6624 evidence/task/state notes.
...
- worker heartbeat age: `29076 ms`, threshold `60000 ms`
- market data age: `29076 ms`, threshold `120000 ms`
...
- checked at: `2026-07-01T12:20:57.713Z`
- `shouldRollback: true`
