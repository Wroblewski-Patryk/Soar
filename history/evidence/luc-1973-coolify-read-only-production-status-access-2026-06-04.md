# LUC-1973 Coolify Read-Only Production Status Access Evidence
...
At `2026-06-04T12:06:24Z`, authenticated read-only Coolify API calls confirmed
...
- Issue: [LUC-1973](/LUC/issues/LUC-1973)
...
| Coolify production environment read `GET /api/v1/projects/{configured-project-id}/production` | pass; six applications, PostgreSQL, Redis |
