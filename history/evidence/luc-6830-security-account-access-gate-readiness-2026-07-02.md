...
- Deployed build-info SHA: `current-production-build-info-unreadable-web-503`
- Build-info readback time: `not checked; production Web/build-info 503 in active Ops evidence`
