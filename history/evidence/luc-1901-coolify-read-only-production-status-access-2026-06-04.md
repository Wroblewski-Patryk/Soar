# LUC-1901 Coolify Read-Only Production Status Access Evidence
...
At `2026-06-04T05:16:05Z`, authenticated read-only Coolify API calls confirmed
...
- Issue: [LUC-1901](/LUC/issues/LUC-1901)
...
| Coolify team list `GET /api/v1/teams` | pass; one team visible to this least-privilege token |
...
| Coolify global resources list `GET /api/v1/resources` | non-authoritative for this proof; latest least-privilege projection returned a narrower visible set than prior inventory proofs |
