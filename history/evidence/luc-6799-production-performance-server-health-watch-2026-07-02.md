# LUC-6799 Production Performance And Server Health Watch
...
- Scoped issue: [LUC-6799](/LUC/issues/LUC-6799), status `in_progress`.
- Existing restoration blocker: [LUC-6331](/LUC/issues/LUC-6331).
- Paperclip readback:
  - `/api/issues/LUC-6799/heartbeat-context` -> `200`
  - issue priority: `critical`
  - first-class blockers on [LUC-6799](/LUC/issues/LUC-6799): none before update
...
- Worktree: dirty before this heartbeat from existing lanes; this heartbeat
  added only scoped [LUC-6799](/LUC/issues/LUC-6799) evidence/task/state notes.
...
- worker heartbeat age: `12518 ms`
- market data age: `12518 ms`
...
- checked at: `2026-07-02T06:21:42.694Z`
- `shouldRollback`: `true`
...
- API `/health`: `200`, `0.101337s`
- API `/ready`: `200`, `0.096710s`
- Web `/`: `503`, `0.087238s`
- Web `/auth/login`: `503`, `0.102522s`
- Web `/api/build-info`: `503`, `0.084481s`
- API `/workers/ready` unauthenticated: `401`, `0.084816s`
