# LUC-2130 Coolify Read-Only Production Status Access Evidence
...
At `2026-06-05T09:05:51Z`, authenticated read-only Coolify API calls confirmed
...
- Issue: [LUC-2130](/LUC/issues/LUC-2130)
