# LUC-1518 Coolify Team/Workspace Confirmation Evidence
...
- `GET /api/issues/LUC-1518/heartbeat-context` -> pass; issue had no
...
`LUC-1518`. `COOLIFY_SOAR_TEAM_ID` / `COOLIFY_TEAM_ID` remain absent in this
