# LUC-1548 Coolify Team Workspace Confirmation Evidence
...
- Issue: `LUC-1548` `[Operator][Coolify] Confirm expected Coolify team/workspace`
...
| Check | Result |
| --- | --- |
| Paperclip heartbeat context `GET /api/issues/LUC-1548/heartbeat-context` | pass |
...
Fresh redacted readback timestamp: `2026-06-02T16:34:09Z`.

## Confirmed Selector

- Expected Coolify team/workspace selector: team id `0`, name `LuckySparrow`.
- Visible teams in this credential context: id `0` `LuckySparrow`, id `2` `empty - change it`.
