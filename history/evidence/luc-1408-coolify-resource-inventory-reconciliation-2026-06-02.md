...
Fresh redacted Coolify API projection captured at `2026-06-02T04:03:34Z`.
...
| Type | Name | Status | Branch | Public FQDN | Restart Count | Last Online | Server Status | Verification role |
| --- | --- | --- | --- | --- | ---: | --- | --- | --- |
| application | `soar-api` | `running:unknown` | `main` | yes | 5 | `2026-06-02 04:03:16` | true | API public/protected readiness |
| application | `soar-web` | `running:unknown` | `main` | yes | 0 | `2026-06-02 04:03:16` | true | Web route and build-info |
| application | `workers-backtest` | `running:unknown` | `main` | no | 0 | `2026-06-02 04:03:16` | true | Backtest worker liveness |
| application | `workers-execution` | `running:unknown` | `main` | no | 0 | `2026-06-02 04:03:16` | true | Execution worker liveness |
| application | `workers-market-data` | `running:unknown` | `main` | no | 0 | `2026-06-02 04:03:16` | true | Market-data worker liveness |
| application | `workers-market-stream` | `running:unknown` | `main` | no | 0 | `2026-06-02 04:03:16` | true | Market-stream worker liveness |
| standalone-postgresql | `postgresql` | `running:healthy` | n/a | no | 52 | `2026-06-02 04:03:16` | true | Production database dependency |
| standalone-redis | `redis` | `running:healthy` | n/a | no | 682 | `2026-06-02 04:03:16` | true | Cache/queue dependency |
...
plus PostgreSQL and Redis. There is no inventory drift from the prior LUC-1405
readback.
