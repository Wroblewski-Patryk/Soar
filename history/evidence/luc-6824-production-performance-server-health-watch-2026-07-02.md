# LUC-6824 Production Performance And Server Health Watch
...
- Scoped issue: [LUC-6824](/LUC/issues/LUC-6824), status `in_progress`.
...
- Paperclip readback:
  ...
  - first-class blockers on [LUC-6824](/LUC/issues/LUC-6824): none before update
...
- Worktree: dirty before this heartbeat from existing lanes; this heartbeat
  added only scoped [LUC-6824](/LUC/issues/LUC-6824) evidence/task/state notes.
...
- worker heartbeat age: `11201 ms`
- market data age: `11201 ms`
...
- checked at: `2026-07-02T08:22:21.598Z`
- `shouldRollback`: `true`
...
- API `/health`: `200`, `0.099531s`
- API `/ready`: `200`, `0.078903s`
- Web `/`: `503`, `0.079030s`
- Web `/auth/login`: `503`, `0.094433s`
- Web `/api/build-info`: `503`, `0.097509s`
- API `/workers/ready` unauthenticated: `401`, `0.079717s`
...
- checked at: `2026-07-02T08:22:59.672Z`
- `/api/v1/version`: `200`
