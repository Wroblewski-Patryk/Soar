# LUC-2122 Coolify Read-Only Production Status Access Evidence
...
At `2026-06-05T08:51:47Z`, authenticated read-only Coolify API calls confirmed
...
- Issue: [LUC-2122](/LUC/issues/LUC-2122)
