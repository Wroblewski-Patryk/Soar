...
- Deployed build-info SHA: `de3db789177cd497447343395d335fca6a84444c`
...
| `PROD_UI_AUDIT_*` | present | 3 | Authenticated production dashboard/admin UI clickthrough |
| `PROD_UI_*` | present | 3 | Legacy production UI audit input family |
