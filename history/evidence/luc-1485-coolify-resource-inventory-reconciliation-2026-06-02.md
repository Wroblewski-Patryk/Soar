# LUC-1485 Coolify Resource Inventory Reconciliation Evidence
...
- Issue: `LUC-1485` `[Ops][Soar] Reconcile Coolify resource inventory`
...
| Check | Result |
| --- | --- |
| Paperclip heartbeat context `GET /api/issues/LUC-1485/heartbeat-context` | pass |
...
| Coolify production environment read `GET /api/v1/projects/{configured-project-id}/production` | pass: `200`, production environment id `6` |
| Coolify resources list `GET /api/v1/resources` | pass: `200`, `17` total rows visible to read-only token |

Fresh redacted readback timestamp: `2026-06-02T10:08:00Z`.
