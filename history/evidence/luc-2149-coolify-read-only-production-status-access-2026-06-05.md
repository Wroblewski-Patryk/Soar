# LUC-2149 Coolify Read-Only Production Status Access Evidence
...
At `2026-06-05T09:52:00Z`, authenticated read-only Coolify API calls confirmed
...
- Issue: [LUC-2149](/LUC/issues/LUC-2149)
...
| Data-service object-shape readback | pass; PostgreSQL and Redis report `running:healthy` |
