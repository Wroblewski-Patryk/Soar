# LUC-1843 Coolify Read-Only Production Status Access Evidence
...
At `2026-06-03T21:02:39Z`, authenticated read-only Coolify API calls
...
resource names, and resource status summaries. No secret values or raw resource
identifiers were printed or stored.
...
| Resource | Coolify type | Inventory status |
| --- | --- | --- |
