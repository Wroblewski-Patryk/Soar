...
- Build-info readback time: `2026-06-03T13:12:53.834Z`
...
- Status: `PARTIAL`
- Matching protected input names present: `5`
...
| `PROD_UI_AUDIT_*` | present | 5 | Authenticated production dashboard/admin UI clickthrough |
| `PROD_UI_*` | present | 5 | Legacy production UI audit input family |
