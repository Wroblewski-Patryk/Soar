# LUC-2251 Coolify Read-Only Production Status Access Evidence
...
At `2026-06-05T17:52:31Z`, authenticated read-only Coolify API calls confirmed
...
- Current selector resolves to `LuckySparrow`; one team is visible in this
  runner.
