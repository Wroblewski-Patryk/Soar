# LUC-2222 Coolify Read-Only Production Status Access Evidence
...
At `2026-06-05T15:34:58Z`, authenticated read-only Coolify API calls confirmed
...
- Issue: [LUC-2222](/LUC/issues/LUC-2222)
