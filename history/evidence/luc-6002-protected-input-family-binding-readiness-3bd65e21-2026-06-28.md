...
- Build-info readback time: `2026-06-28T15:06:34.634Z`
...
- Status: `PARTIAL`
- Matching protected input names present: `12`
...
| --- | --- | --- | --- |
| `LIVEIMPORT_READBACK_*` | present | 10 | Protected LIVEIMPORT-03 production runtime readback |
| `ROLLBACK_GUARD_*` | missing | 0 | Protected production rollback/runtime freshness proof |
| `PROD_UI_AUDIT_*` | present | 2 | Authenticated production dashboard/admin UI clickthrough |
| `PROD_UI_*` | present | 2 | Legacy production UI audit input family |
