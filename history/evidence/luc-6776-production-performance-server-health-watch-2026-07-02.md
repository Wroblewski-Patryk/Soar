# LUC-6776 Production Performance And Server Health Watch
...
- Scoped issue: [LUC-6776](/LUC/issues/LUC-6776), status `in_progress`.
- Existing restoration blocker: [LUC-6331](/LUC/issues/LUC-6331).
- Paperclip readback:
  - `/api/issues/LUC-6776/heartbeat-context` -> `200`
  - issue priority: `critical`
  - first-class blockers on [LUC-6776](/LUC/issues/LUC-6776): none before update
...
- Worktree: dirty before this heartbeat from existing lanes; this heartbeat
  added only scoped [LUC-6776](/LUC/issues/LUC-6776) evidence/task/state notes.
...
- worker heartbeat age: `15533 ms`
- market data age: `15533 ms`
...
- checked at: `2026-07-02T04:21:15.562Z`
- `shouldRollback`: `true`
...
- API `/health`: `200`, `0.094037s`
- API `/ready`: `200`, `0.133469s`
- Web `/`: `503`, `0.083681s`
- Web `/auth/login`: `503`, `0.120814s`
- Web `/api/build-info`: `503`, `0.094126s`
- API `/workers/ready` unauthenticated: `401`, `0.098988s`
