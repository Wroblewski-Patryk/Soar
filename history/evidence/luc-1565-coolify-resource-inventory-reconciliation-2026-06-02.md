# LUC-1565 Coolify Resource Inventory Reconciliation - 2026-06-02
...
Captured at `2026-06-02T17:34:56Z`.
...
| `GET /api/v1/projects/{configured-project-id}/environments` | pass; one environment returned |
