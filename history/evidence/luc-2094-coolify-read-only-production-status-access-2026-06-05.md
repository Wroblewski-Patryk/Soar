# LUC-2094 Coolify Read-Only Production Status Access Evidence
...
At `2026-06-05T06:18:48Z`, authenticated read-only Coolify API calls confirmed
...
- Issue: [LUC-2094](/LUC/issues/LUC-2094)
