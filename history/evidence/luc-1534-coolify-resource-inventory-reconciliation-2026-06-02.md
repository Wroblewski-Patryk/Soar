# LUC-1534 Coolify Resource Inventory Reconciliation Evidence
...
- Issue: `LUC-1534` `[Ops][Soar] Reconcile Coolify resource inventory`
...
- The previous heartbeat failed before domain work with adapter error `EEXIST` while creating the Codex auth symlink; this run treated that as harness setup drift and continued with the already-claimed issue.
...
Fresh redacted readback timestamp: `2026-06-02T16:02:56Z`.
