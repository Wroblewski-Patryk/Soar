# LUC-6606 Production Performance And Server Health Watch
...
- Worktree: dirty before this heartbeat from existing product, docs, evidence,
  ...
  LUC-6606 evidence/task/state notes.
...
- worker heartbeat age: `12180 ms`, threshold `60000 ms`
- market data age: `12180 ms`, threshold `120000 ms`
