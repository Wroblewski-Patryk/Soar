# LUC-1916 Coolify Read-Only Production Status Access Evidence
...
At `2026-06-04T06:19:39Z`, authenticated read-only Coolify API calls confirmed
...
- Issue: [LUC-1916](/LUC/issues/LUC-1916)
