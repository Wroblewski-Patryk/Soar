# LUC-1673 Coolify Resource Inventory Reconciliation - 2026-06-03
...
Captured at `2026-06-03T05:36:00Z`.

| Probe | Result |
| --- | --- |
| `GET /api/issues/LUC-1673/heartbeat-context` | pass; issue `LUC-1673` read back as `blocked`, priority `critical`, zero first-class blockers |
