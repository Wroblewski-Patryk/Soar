# LUC-1933 Coolify Read-Only Production Status Access Evidence
...
At `2026-06-04T08:48:23Z`, authenticated read-only Coolify API calls confirmed
...
- Issue: [LUC-1933](/LUC/issues/LUC-1933)
...
| Coolify global resources list `GET /api/v1/resources` | pass; `17` visible rows |
