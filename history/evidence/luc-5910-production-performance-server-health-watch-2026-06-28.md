# LUC-5910 Production Performance And Server Health Watch

## Status

- Result: **DONE / VERIFIED_READ_ONLY / APP_HEALTHY / MARKET_CATALOG_COLD_SAMPLE_WATCH / COOLIFY_QUEUE_WATCH**
- Issue: [LUC-5910](/LUC/issues/LUC-5910)
- Evidence window: 2026-06-28T10:23Z to 2026-06-28T10:25Z
...
- `checkedAt`: `2026-06-28T10:24:51.236Z`
...
| --- | --- | ---: | ---: | --- |
| API `/health` | `200:8` | 157.2 | 47.7 | 157.2, 74.9, 18.6, 26.6, 31.0, 16.3, 29.1, 28.2 |
| API `/ready` | `200:8` | 27.8 | 21.6 | 27.8, 20.4, 25.2, 22.1, 18.3, 19.0, 17.6, 22.7 |
| Web `/` | `200:8` | 94.9 | 44.4 | 94.9, 77.2, 28.7, 29.2, 30.8, 32.6, 34.2, 27.4 |
| Web `/api/build-info` | `200:8` | 32.3 | 28.4 | 29.6, 32.3, 32.2, 30.7, 31.7, 15.4, 29.9, 25.2 |
...
| --- | --- | ---: | ---: | --- |
| `/auth/me` | `200:3` | 72.6 | 43.5 | 72.6, 31.2, 26.8 |
| `/dashboard/bots` | `200:3` | 50.0 | 38.3 | 50.0, 32.0, 33.0 |
| `/dashboard/wallets` | `200:3` | 31.5 | 30.5 | 30.2, 31.5, 29.7 |
| `/dashboard/markets/catalog` | `200:3` | 1455.8 | 509.3 | 1455.8, 44.0, 28.2 |
| `/dashboard/strategies` | `200:3` | 27.6 | 27.3 | 26.6, 27.6, 27.6 |
| `/dashboard/backtests/runs` | `200:3` | 31.7 | 31.0 | 30.6, 30.6, 31.7 |
| `/dashboard/reports/cross-mode-performance` | `200:3` | 203.7 | 103.8 | 53.2, 54.6, 203.7 |
| `/dashboard/logs` | `200:3` | 36.4 | 30.3 | 36.4, 26.5, 28.1 |
| `/dashboard/profile/subscription` | `200:3` | 42.1 | 37.6 | 42.1, 39.8, 30.8 |
| `/admin/users` | `200:3` | 34.2 | 30.8 | 30.9, 27.2, 34.2 |
| `/admin/subscriptions/plans` | `200:3` | 32.1 | 29.8 | 32.1, 30.1, 27.3 |

Focused follow-up for `/dashboard/markets/catalog`:

| Endpoint | Statuses | Max ms | Avg ms | Samples ms |
| --- | --- | ---: | ---: | --- |
| `/dashboard/markets/catalog` | `200:8` | 31.6 | 29.2 | 22.3, 27.5, 31.6, 31.6, 30.1, 30.9, 30.3, 29.5 |
...
- worker heartbeat freshness: PASS, age `20945 ms`, threshold `60000 ms`
- market data freshness: PASS, age `20945 ms`, threshold `120000 ms`
...
- checked at `2026-06-28T10:23:50.982Z`
...
| Check | Result | Timing |
| --- | --- | ---: |
| `GET /api/v1/version` | pass `200` | 212 ms |
| `GET /api/v1/teams/current` | pass `200` | 103 ms |
| `GET /api/v1/projects/{configured-project-id}` | pass `200` | 59 ms |
| `GET /api/v1/projects/{configured-project-id}/environments` | pass `200` | 55 ms |
| `GET /api/v1/projects/{configured-project-id}/production` | pass `200` | 112 ms |
| `GET /api/v1/resources` | pass `200` | 179 ms |
...
[LUC-5910](/LUC/issues/LUC-5910) can close as a read-only production performance and server-health checkpoint:
...
- one `/dashboard/markets/catalog` cold sample reached `1455.8 ms`, then normalized to max `31.6 ms`
