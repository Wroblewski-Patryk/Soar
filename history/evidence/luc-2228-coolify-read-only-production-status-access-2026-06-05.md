# LUC-2228 Coolify Read-Only Production Status Access Evidence
...
At `2026-06-05T15:55:09Z`, authenticated read-only Coolify API calls confirmed
...
- Issue: [LUC-2228](/LUC/issues/LUC-2228)
...
| Coolify global resources list `GET /api/v1/resources` | pass; `17` visible rows in this runner; not used as release authority |
