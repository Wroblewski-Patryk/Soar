# LUC-2014 Coolify Read-Only Production Status Access Evidence
...
At `2026-06-04T16:46:41Z`, authenticated read-only Coolify API calls confirmed
...
- Issue: [LUC-2014](/LUC/issues/LUC-2014)
...
| Coolify production object shape check | pass; typed keys include `applications`, `postgresqls`, `redis`, and `services` |
