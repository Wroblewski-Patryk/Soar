# LUC-1919 Coolify Read-Only Production Status Access Evidence
...
At `2026-06-04T06:35:51Z`, authenticated read-only Coolify API calls confirmed
...
- Issue: [LUC-1919](/LUC/issues/LUC-1919)
...
| Coolify resources list `GET /api/v1/resources` | pass; `17` visible rows; `8` rows match production environment id `6`; `9` Soar-relevant safe projection rows due to one PostgreSQL companion row |
