# LUC-6757 Production Performance And Server Health Watch
...
- Scoped issue: [LUC-6757](/LUC/issues/LUC-6757), status `in_progress`.
- Existing restoration blocker: [LUC-6331](/LUC/issues/LUC-6331).
- Paperclip readback:
  - `/api/issues/LUC-6757/heartbeat-context` -> `200`
  - `/api/issues/LUC-6757` -> `200`
...
- Worktree: dirty before this heartbeat from existing lanes; this heartbeat
  added only scoped LUC-6757 evidence/task/state notes.
...
- worker heartbeat age: `1180 ms`
- market data age: `1180 ms`
...
- checked at: `2026-07-02T02:23:58.185Z`
- `shouldRollback`: `true`
...
- API `/health`: `200`, `0.117822s`
- API `/ready`: `200`, `0.099176s`
- Web `/`: `503`, `0.103869s`
- Web `/auth/login`: `503`, `0.104415s`
- Web `/api/build-info`: `503`, `0.111745s`
- API `/workers/ready` unauthenticated: `401`, `0.126997s`
