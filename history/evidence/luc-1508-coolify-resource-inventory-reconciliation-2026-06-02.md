# LUC-1508 Coolify Resource Inventory Reconciliation Evidence
...
- Issue: `LUC-1508` `[Ops][Soar] Reconcile Coolify resource inventory`
...
| Check | Result |
| --- | --- |
| Paperclip heartbeat context `GET /api/issues/LUC-1508/heartbeat-context` | pass |
...
Fresh redacted readback timestamp: `2026-06-02T14:02:57Z`.
...
- `COOLIFY_SOAR_TEAM_ID` and `COOLIFY_TEAM_ID` are absent, but they are not an active blocker while project-scoped reads succeed.
