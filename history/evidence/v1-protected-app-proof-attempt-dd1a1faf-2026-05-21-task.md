...
- Status: BLOCKED
- Owner: Ops/Release
- Depends on: `history/releases/v1-operator-unblock-packet-dd1a1faf-2026-05-20.md`
- Priority: P0
...
| Ops protected proof | Coordinator | `history/releases/v1-operator-unblock-packet-dd1a1faf-2026-05-20.md` | Existing ops scripts only | UI, rollback, liveimport, SLO artifacts | Command exits and artifact readback | BLOCKED |
...
- Tests:
  ...
  - `corepack pnpm run ops:protected-inputs:check -- --today 2026-05-21 --expected-sha dd1a1faf79f8ac3581ca0a8c983481a3e30327ac --json-output history/artifacts/v1-protected-input-readiness-dd1a1faf-2026-05-21.json --markdown-output history/evidence/v1-protected-input-readiness-dd1a1faf-2026-05-21.md` BLOCKED names-only, because protected values were supplied in chat and not persisted as shell env.
  - `corepack pnpm run ops:ui:prod-clickthrough -- --expected-sha dd1a1faf79f8ac3581ca0a8c983481a3e30327ac --today 2026-05-21 --output-json history/artifacts/_artifacts-prod-ui-module-clickthrough-dd1a1faf-2026-05-21.json --output-md history/plans/prod-ui-module-clickthrough-dd1a1faf-2026-05-21.md` PASS.
  - `corepack pnpm run ops:deploy:rollback-proof -- --profile prod --base-url https://api.soar.luckysparrow.ch --today 2026-05-21` PASS.
  - `corepack pnpm run ops:liveimport:readback -- --expected-sha dd1a1faf79f8ac3581ca0a8c983481a3e30327ac --symbols BNBUSDT,XRPUSDT --output history/artifacts/liveimport-03-prod-readback-dd1a1faf-2026-05-21.json` FAIL as expected: runtime session exists, but no open runtime readback payload exists for the visible historical symbols.
  ...
  - `corepack pnpm run ops:slo:collect -- --base-url https://api.soar.luckysparrow.ch --duration-minutes 30 --interval-seconds 30 --environment production` FAIL overall. Evidence: `history/evidence/v1-slo-observation-2026-05-21T15-28-20-108Z.md`, `history/artifacts/_artifacts-slo-window-2026-05-21T15-28-20-108Z.json`.
...
- Architecture source reviewed: `history/releases/v1-operator-unblock-packet-dd1a1faf-2026-05-20.md`, `docs/operations/coolify-linux-vps-setup-guide.md`.
