# LUC-1659 Local Protected Route Action Proof Matrix
...
- Generated at (UTC): 2026-07-22T21:52:55.325Z
- Raw JSON: `history\artifacts\luc-1659-local-protected-route-action-proof-matrix-2026-07-22.json`
...
| SOAR-ACTION-VISIT-PAGE-BOT-CREATE | `bots list-page add action` | FAIL | `/dashboard/bots` | clicked create/add action (Create bot), expected create route |
