# LUC-1677 Coolify Read-Only Production Status Access Evidence
...
At `2026-06-03T05:39:51Z`, authenticated read-only Coolify API calls confirmed
...
| Check | Result |
| --- | --- |
| Paperclip heartbeat context `GET /api/issues/LUC-1677/heartbeat-context` | pass; issue `LUC-1677` read back as `blocked`, priority `critical`, zero first-class blockers |
