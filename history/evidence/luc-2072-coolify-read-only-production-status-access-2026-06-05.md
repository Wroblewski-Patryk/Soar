# LUC-2072 Coolify Read-Only Production Status Access Evidence
...
At `2026-06-05T03:33:51Z`, authenticated read-only Coolify API calls confirmed
...
- Issue: [LUC-2072](/LUC/issues/LUC-2072)
...
| Data-service object-shape readback | pass; redacted PostgreSQL and Redis projections report `running:healthy` |
