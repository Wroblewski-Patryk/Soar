# LUC-1969 Coolify Read-Only Production Status Access Evidence
...
At `2026-06-04T11:47:06Z`, authenticated read-only Coolify API calls confirmed
...
- Issue: [LUC-1969](/LUC/issues/LUC-1969)
