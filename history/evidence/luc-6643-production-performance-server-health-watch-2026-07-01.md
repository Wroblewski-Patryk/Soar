# LUC-6643 Production Performance And Server Health Watch
...
- Worktree: dirty before this heartbeat from existing product, docs, evidence,
  ...
  LUC-6643 evidence/task/state notes.
...
- worker heartbeat age: `17734 ms`, threshold `60000 ms`
- market data age: `17734 ms`, threshold `120000 ms`
...
- checked at: `2026-07-01T14:21:31.988Z`
- `shouldRollback: true`
