...
- Implementation notes:
  ...
  - Local evidence was written to `history/evidence/v1-restore-drill-prod-2026-05-12T15-21-38Z.md` and `history/artifacts/_artifacts-restore-drill-prod-coolify-2026-05-12T15-21-38Z.json`.
...
- Docs updated:
  ...
  - `history/artifacts/_artifacts-v1-release-gate-prod-2026-05-12Trestore-refresh-dry-run.json`
