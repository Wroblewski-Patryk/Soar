...
- Result: **PASS**
- Issue: [LUC-2261](/LUC/issues/LUC-2261)
- Environment: local production Web server
- Evidence date: 2026-06-05
- Generated at (UTC): 2026-06-05T18:44:48.258Z
- Web base URL: `http://127.0.0.1:3101`
- Raw JSON: `history\artifacts\luc-2261-local-public-read-only-browser-proof-2026-06-05.json`
