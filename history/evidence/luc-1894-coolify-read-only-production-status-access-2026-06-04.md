# LUC-1894 Coolify Read-Only Production Status Access Evidence
...
At `2026-06-04T04:46:27Z`, authenticated read-only Coolify API calls confirmed
...
- Issue: [LUC-1894](/LUC/issues/LUC-1894)
...
| Coolify team list `GET /api/v1/teams` | pass; one team visible |
...
| Coolify resources list `GET /api/v1/resources` | pass; one visible row in this token context |
