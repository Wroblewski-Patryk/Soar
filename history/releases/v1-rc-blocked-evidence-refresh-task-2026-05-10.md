...
- `history/artifacts/_artifacts-v1-final-preflight-1609929e-2026-05-10.json`
...
- Manual checks:
  ...
  - BLOCKED as expected: `node scripts\runV1FinalPreflight.mjs --expected-sha 1609929ed3b98c2b794d8a0b48ff0f39c16cd75f --today 2026-05-10 --json-output history/artifacts/_artifacts-v1-final-preflight-1609929e-2026-05-10.json --markdown-output history/releases/v1-final-preflight-1609929e-2026-05-10.md`.
- Screenshots/logs:
  - `history/releases/v1-final-preflight-1609929e-2026-05-10.md`.
- High-risk checks:
  - no secrets used
