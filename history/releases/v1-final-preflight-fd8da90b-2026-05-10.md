...
## Context
- Generated (UTC): 2026-05-10T04:46:09.444Z
- Status: blocked
- API base URL: https://api.soar.luckysparrow.ch
- Web base URL: https://soar.luckysparrow.ch
- Expected SHA: fd8da90bd77c2ddbed800eabd98479c1bd113ac4
- Evidence date: 2026-05-10
- Build-info: pass
- Public smoke: pass
- Raw JSON: history\artifacts\_artifacts-v1-final-preflight-fd8da90b-2026-05-10.json
...
| --- | --- | --- | --- | --- |
| activation evidence audit | fresh | yes | 2026-05-10 | fresh for 2026-05-10 |
| activation execution plan | fresh | yes | 2026-05-10 | fresh for 2026-05-10 |
| RC external gates status | failed | yes | 2026-05-10 | artifact is fresh but does not show all RC gates PASS |
| RC sign-off record | failed | yes | 2026-05-10 | artifact is fresh but does not report RC status APPROVED |
| RC checklist verification block | failed | yes | 2026-05-10 | artifact is fresh but does not show all RC gates PASS |
| LIVEIMPORT-03 runtime readback | missing | yes | - | no matching artifact found |
| backup/restore drill evidence | fresh | yes | 2026-05-10 | fresh for 2026-05-10 |
| rollback proof pack | failed | yes | 2026-05-10 | artifact is fresh but does not report PASS |
