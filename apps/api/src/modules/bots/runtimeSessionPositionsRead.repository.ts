...
export const sumRuntimeManagedPositionQuantity = async (where: Prisma.PositionWhereInput) =>
  prisma.position.aggregate({
    where,
    _sum: {
      quantity: true,
...
export const sumRuntimeManagedPositionMarginUsed = async (where: Prisma.PositionWhereInput) =>
  prisma.position.aggregate({
    where,
    _sum: {
      marginUsed: true,
...
export const sumRuntimeManagedPositionUnrealizedPnl = async (where: Prisma.PositionWhereInput) =>
  prisma.position.aggregate({
    where,
    _sum: {
      unrealizedPnl: true,
