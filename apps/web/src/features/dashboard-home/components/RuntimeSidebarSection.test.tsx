...
const createProps = (overrides?: Partial<RuntimeSidebarSectionProps>): RuntimeSidebarSectionProps => {
  ...
  const baseProps = {
    ...
    manualOrder: {
      ...
      stateLabel: "Waiting for fill",
      stateDescription: "Order is pending exchange confirmation.",
      stateToneClassName: "border-amber-400/40 bg-amber-500/10 text-amber-100",
      stateBadgeClassName: "border-amber-400/50 bg-amber-500/15 text-amber-100",
