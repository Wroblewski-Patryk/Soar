export const dashboardWalletsPl = {
  ...
  preview: {
    title: "Podglad portfela",
    breadcrumb: "Podglad",
    loadError: "Nie udalo sie zaladowac podgladu portfela.",
    loading: "Ladowanie podgladu portfela",
    loadingDescription: "Pobieranie analityki portfela i historii przeplywow.",
    errorTitle: "Nie udalo sie zaladowac podgladu portfela",
    retry: "Sprobuj ponownie",
    backToList: "Wroc do listy",
    edit: "Edytuj portfel",
    refresh: "Odswiez",
    noLedgerTitle: "Brak danych ledger portfela",
    noLedgerDescription: "Ten portfel nie ma jeszcze snapshotow salda ani zdarzen cashflow.",
    partialTitle: "Ledger jest czesciowy",
    partialDescription: "Czesc ruchow na gieldzie nie jest jeszcze w pelni sklasyfikowana. Nieznane korekty pozostaja widoczne zamiast liczyc sie jako PnL bota.",
    summary: "Podsumowanie",
    currentBalance: "Saldo konta",
    allocatedBalance: "Saldo alokowane",
    contributedCapital: "Kapital wniesiony",
    botPnl: "PnL bota",
    botRealizedPnl: "Zrealizowany PnL bota",
    botOpenPnl: "Otwarty PnL bota",
    feesFunding: "Prowizje i funding",
    walletDelta: "Delta portfela",
    unclassifiedAdjustment: "Nieznana korekta",
    latestSnapshot: "Ostatni snapshot",
    equityTimeline: "Historia wartosci",
    noTimelineTitle: "Brak punktow wykresu",
    noTimelineDescription: "Snapshoty salda pojawia sie tutaj po odswiezeniu portfela.",
    cashflowEvents: "Zdarzenia cashflow",
    noEventsTitle: "Brak zdarzen cashflow",
    noEventsDescription: "Saldo poczatkowe, wplaty, wyplaty i zdarzenia ledger bota pojawia sie tutaj.",
    eventTime: "Czas",
    eventSource: "Zrodlo",
    eventAmount: "Kwota",
    eventReference: "Referencja",
    accountBalance: "Saldo konta",
    freeBalance: "Srodki wolne",
    portfolioEquity: "Wartosc portfela",
