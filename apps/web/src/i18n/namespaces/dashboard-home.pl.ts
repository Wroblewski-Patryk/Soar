export const dashboardHomePl = {
  ...
  "runtime": {
    ...
    "manualOrderSuccess": "Zlecenie reczne wyslane (sciezka order-only).",
    "manualOrderError": "Nie udalo sie otworzyc zlecenia recznego.",
    "manualOrderSemanticsHint": "Zlecenie reczne sklada tylko zlecenie. Cykl pozycji aktualizuje sie po fill/runtime sync.",
