export const dashboardHomeEn = {
  ...
  "runtime": {
    ...
    "cancelOpenOrderUnsupported": "Exchange cancel unsupported",
    "cancelOpenOrderSuccess": "Order canceled.",
    "cancelOpenOrderError": "Failed to cancel order.",
    "riskConfirmTitle": "Confirm runtime action",
    "riskConfirmManualOrderDescription": "This can affect a LIVE runtime account. Confirm that you want to submit this manual order.",
    "riskConfirmCancelOrderDescription": "This can affect a LIVE runtime account. Confirm that you want to cancel this open order.",
    "riskConfirmClosePositionDescription": "This can affect a LIVE runtime account. Confirm that you want to close this position.",
    "riskConfirmConfirmLabel": "Confirm",
    "riskConfirmCancelLabel": "Cancel",
    ...
    "closedPositionsHistoryTitle": "Closed positions",
    ...
    "closeReasonAccountFloor": "Account floor",
    "closeReasonManual": "Manual",
    "closeReasonSignalExit": "Signal exit",
    "closeReasonPositionLifetime": "Position lifetime",
    "closeReasonExternalSyncMissing": "External sync",
    "closeReasonSystemRepair": "System repair",
    ...
    "provenanceExchangeAdopted": "Exchange adopted",
    "provenanceExchangeUnowned": "Exchange unowned",
    "provenanceExchangeAmbiguous": "Exchange ambiguous",
    "provenanceExchangeManualOnly": "Manual-only exchange",
    "provenanceExchangeSynced": "Exchange synced",
    "provenanceSyncDrift": "Sync drift",
    "provenanceSyncOrphanLocal": "Local orphan",
    "provenanceSyncOrphanExchange": "Exchange orphan",
