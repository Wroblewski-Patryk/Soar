export const dashboardHomeEn = {
  ...
  "runtime": {
    ...
    "manualOrderSuccess": "Manual order submitted (order-only path).",
    "manualOrderError": "Failed to open manual order.",
    "manualOrderSemanticsHint": "Manual order places an order only. Position lifecycle updates after fill/runtime sync.",
