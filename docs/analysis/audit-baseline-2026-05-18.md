...
| --- | --- | --- |
| `pnpm run ops:project:index` | PASS | `docs/operations/project-index-2026-05-18.md`, `docs/operations/project-index-2026-05-18.json`; V1 statuses `PASS:21`, tests indexed `335`. |
| `pnpm run ops:project:scan -- --index docs/operations/project-index-2026-05-18.json` | PASS | `docs/operations/v1-static-issue-scan-2026-05-18.md`, `docs/operations/v1-static-issue-scan-2026-05-18.json`; findings `0`. |
...
| `pnpm i18n:audit:route-reachable:web` | PASS | Route-reachable i18n audit wrote `docs/operations/_artifacts-l10nq-d-coverage-audit-latest.json`; findings `0`, localCopy `0`, fallbackPl `0`, hardcoded `0`. |
