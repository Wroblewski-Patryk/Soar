...
- `history/audits/audit-baseline-2026-05-18.md` includes the broad local audit
  ...
  route-state proof.
- `history/audits/audit-baseline-2026-05-19.md` extends `AUD-04` and `AUD-05`
...
- `history/audits/full-reusable-audit-rollup-2026-05-19.md` is the final
  2026-05-19 reusable audit rollup for `AUD-00` through `AUD-23`.
- `history/plans/project-index-2026-05-19.md`,
  `history/audits/v1-static-issue-scan-2026-05-19.md`, and
  `history/audits/requirements-delivery-map-audit-2026-05-19.md` refresh
