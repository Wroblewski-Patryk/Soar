...
`docs/operations/v1-production-activation-closure-2026-04-22.md` still says
`CLOSED_WITH_OPERATOR_BLOCKERS` and `docs/operations/v1-production-activation-pack-2026-04-22.md`
