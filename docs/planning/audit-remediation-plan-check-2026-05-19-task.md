...
- Architecture source reviewed: `.agents/core/project-memory-index.md`, `.agents/core/mission-control.md`, `docs/planning/audit-remediation-master-plan-2026-05-19.md`
