...
- Manual checks:
  - `rg -n "4792fbca|4ee1672e|Result: \\*\\*BLOCKED\\*\\*" docs/operations/v1-protected-access-readiness-2026-05-09.md docs/planning/v1-protected-access-readiness-task-2026-05-09.md`
- Screenshots/logs:
  - not applicable
- High-risk checks:
