...
- Tests:
  ...
  - `git diff --check`
- Manual checks:
  - `node scripts/runV1FinalPreflight.mjs --api-base-url https://api.soar.luckysparrow.ch --web-base-url https://soar.luckysparrow.ch --expected-sha 90cd07d602f0a31f315719b8a5cd5be3fd112313 --timeout-seconds 120 --interval-seconds 15 --today 2026-05-09 --json-output docs/operations/_artifacts-v1-final-preflight-90cd07d6-2026-05-09.json --markdown-output docs/operations/v1-final-preflight-90cd07d6-2026-05-09.md`
- Screenshots/logs:
  - `docs/operations/v1-final-preflight-90cd07d6-2026-05-09.md`
  - `docs/operations/_artifacts-v1-final-preflight-90cd07d6-2026-05-09.json`
- High-risk checks:
