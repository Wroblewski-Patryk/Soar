...
- Architecture source reviewed: `docs/security/secure-development-lifecycle.md`; `docs/architecture/architecture-source-of-truth.md`; `docs/operations/v1-product-action-audit-matrix-2026-05-10.md`
