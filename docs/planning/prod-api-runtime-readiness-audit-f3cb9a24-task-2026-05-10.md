...
- Tests:
  ...
  - `node scripts/collectLiveImportReadbackEvidence.mjs ... --expected-sha f3cb9a24... --bot-id <redacted-live-bot-id> --symbols ETHUSDT,DOGEUSDT --output docs/operations/_artifacts-liveimport-readback-f3cb9a24-2026-05-10.json` exited fail-closed after writing evidence because there is no running LIVE runtime session.
- Manual checks:
