...
- Screenshots/logs: `C:\Users\wrobl\AppData\Local\Temp\v1ui35-dashboard-smoke.png`; route-reachable i18n audit artifact refreshed at `docs/operations/_artifacts-l10nq-d-coverage-audit-latest.json`.
