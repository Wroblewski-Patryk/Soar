...
- Tests:
  ...
  - `git diff --check`
- Manual checks:
  - `node scripts\runProdUiModuleClickthroughAudit.mjs --web-base-url https://soar.luckysparrow.ch --api-base-url https://api.soar.luckysparrow.ch --expected-sha 88313309200d35275ba6c0d3465c5045c4b6d99e --today 2026-05-10 --output-json docs\operations\_artifacts-prod-ui-module-clickthrough-88313309-2026-05-10.json --output-md docs\operations\prod-ui-module-clickthrough-88313309-2026-05-10.md`
