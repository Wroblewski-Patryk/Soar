...
- Manual checks: `docs/operations/v1-release-gate-prod-2026-05-12Tnon-dry-run-blocked.md` shows `Dry run: no`, build-info PASS, public API/Web smoke reached, protected smoke/evidence blockers retained.
- Reality status: verified blocked; V1 remains `NO-GO`.

## Architecture Evidence
- Architecture source reviewed: `DEPLOYMENT_GATE.md`, `docs/operations/v1-operator-unblock-packet-00169d7f-2026-05-12.md`
...
- Evidence artifact: `docs/operations/v1-release-gate-prod-2026-05-12Tnon-dry-run-blocked.md`.
- Raw artifact: `docs/operations/_artifacts-v1-release-gate-prod-2026-05-12Tnon-dry-run-blocked.json`.
