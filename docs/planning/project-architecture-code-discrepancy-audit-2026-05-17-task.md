...
- Tests:
  ...
  - `pnpm run ops:project:scan -- --index docs/operations/project-index-2026-05-17.json` PASS, findings `0`
...
- Docs updated: `docs/analysis/architecture-code-discrepancy-audit-2026-05-17.md`, `docs/analysis/documentation-drift.md`, this task file.
