...
- Tests:
  ...
  - `git diff --check`
- Manual checks:
  - `node scripts\runV1FinalPreflight.mjs --api-base-url https://api.soar.luckysparrow.ch --web-base-url https://soar.luckysparrow.ch --expected-sha 8220532920e484da9ddaa021ac64b5de4cc5e6e1 --timeout-seconds 120 --interval-seconds 15 --today 2026-05-10 --json-output docs\operations\_artifacts-v1-final-preflight-82205329-2026-05-10.json --markdown-output docs\operations\v1-final-preflight-82205329-2026-05-10.md`
