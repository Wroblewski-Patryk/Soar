...
5. Run canonical `LIVEIMPORT-03` collector against production after confirming
   ...
   `pnpm run ops:liveimport:readback -- --expected-sha 00169d7fdc3aff8317759137b05594b20e773c8e --output docs/operations/liveimport-03-prod-readback-00169d7f-2026-05-13.json`.
