...
## Validation Evidence
- Tests:
  - `pnpm run ops:release:v1:preflight -- --timeout-seconds 30 --interval-seconds 5 --json-output docs/operations/_artifacts-v1-final-preflight-current.json --markdown-output docs/operations/v1-final-preflight-current.md` => expected BLOCKED; artifacts written.
