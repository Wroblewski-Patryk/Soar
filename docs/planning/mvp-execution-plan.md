...
## Phase V1RESTART-A - LIVE Position Continuity and Restart Recovery Hardening (Queued 2026-04-28)
...
- [ ] `V1RESTART-02 test(api-red): lock non-destructive restart recovery semantics`
- [ ] `V1RESTART-03 db(schema): add durable recovery state for restart continuity`
- [ ] `V1RESTART-04 fix(api-events): promote exchange-event truth to restart recovery authority`
- [ ] `V1RESTART-05 fix(api-reconciliation): convert reconciliation from one-pass close authority into staged recovery authority`
- [ ] `V1RESTART-06 fix(api-ownership): preserve or restore canonical bot/wallet/strategy continuity for recovered LIVE positions`
- [ ] `V1RESTART-07 test(api-runtime-red): lock post-restart DCA and trailing continuity for recovered exchange-synced LIVE positions`
- [ ] `V1RESTART-08 fix(api-runtime): restore safe automation context for recovered LIVE positions`
- [ ] `V1RESTART-09 fix(api+read): expose honest restart recovery states and certainty to operator surfaces`
- [ ] `V1RESTART-10 web(runtime-truth): show continuity and recovery status explicitly instead of silent disappearance`
- [ ] `V1RESTART-11 qa(closure): run adversarial restart/downtime recovery pack and sync docs/context`
