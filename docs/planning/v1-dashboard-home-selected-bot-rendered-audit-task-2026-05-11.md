...
- Architecture source reviewed: `docs/architecture/reference/dashboard-route-map.md`, `docs/modules/web-dashboard-home.md`, `docs/operations/v1-product-action-audit-matrix-2026-05-10.md`
