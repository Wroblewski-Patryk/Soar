...
- Tests:
  ...
  - `corepack pnpm run audit:manifest:compare -- --base docs/operations/reusable-audit-artifact-manifest-2026-05-19.json --target docs/operations/reusable-audit-artifact-manifest-2026-05-19.json --json-output docs/operations/_tmp-audit-manifest-compare-self-check.json`
