...
- Tests:
  ...
  - `pnpm run ops:project:scan -- --today 2026-05-11 --index docs/operations/project-index-2026-05-11.json` passed; findings now 59 (`P0: 10`, `P1: 16`, `P2: 33`).
  - `pnpm run ops:project:ledger -- --today 2026-05-11 --index docs/operations/project-index-2026-05-11.json --scan docs/operations/v1-static-issue-scan-2026-05-11.json` passed.
  - `pnpm run ops:project:scorecard -- --today 2026-05-11 --ledger docs/operations/v1-master-state-ledger-2026-05-11.json` passed; V1 remains `NO-GO` at implementation `51.6%`, evidence `11.2%`, release readiness `7.8%`.
