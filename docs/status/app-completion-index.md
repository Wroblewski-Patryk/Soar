...
Generated: 2026-07-15T03:43:26.618Z
Project: Soar
...
- Blocked: 0
- Known non-ok risk items: 73
- Priority review items indexed: 73/73
...
- Account access: 13 entities; risks {"ok":12,"missing_doc_link":1}; gates {"auth":13,"subscription":2}
...
| --- | --- | --- | --- | --- | --- | --- |
| Account access | missing_doc_link | screen_or_route | page.tsx | QA Regression Lead | apps/web/src/app/admin/users/page.tsx | auth, subscription |
