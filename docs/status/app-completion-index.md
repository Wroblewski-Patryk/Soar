...
- Items: 86
- User flows: 7
- Needs browser/screenshot review: 27
- Missing test link: 12
- Missing doc link: 2
- Implemented, needs proof: 0
- Blocked: 0
- Known non-ok risk items: 41
- Priority review items indexed: 41/41
- Priority review truncated: false

## Flow Summary

- Account access: 38 entities; risks {"ok":38}; gates {"auth":38,"subscription":3,"configuration":2}
- Dashboard overview: 22 entities; risks {"ok":6,"needs_browser_review":16}; gates {"configuration":1}
