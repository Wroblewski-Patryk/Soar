...
Generated: 2026-07-15T00:25:51.617Z
Project: Soar
...
- Items: 86
- User flows: 7
- Needs browser/screenshot review: 43
...
- Account access: 12 entities; risks {"ok":11,"missing_test_link":1}; gates {"auth":12,"subscription":1}
- Subscription and entitlement: 5 entities; risks {"missing_test_link":3,"needs_browser_review":2}; gates {"subscription":5}
- Admin operation: 3 entities; risks {"ok":1,"needs_browser_review":2}; gates {"auth":2}
...
| --- | --- | --- | --- | --- | --- | --- |
| Account access | missing_test_link | screen_or_route | page.tsx | QA Regression Lead | apps/web/src/app/admin/page.tsx | auth |
