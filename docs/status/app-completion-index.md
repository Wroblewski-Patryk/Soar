...
- Account access: 12 entities; risks {"ok":11,"missing_doc_link":1}; gates {"auth":12,"subscription":1}
...
| --- | --- | --- | --- | --- | --- | --- |
| Account access | missing_doc_link | screen_or_route | page.tsx | QA Regression Lead | apps/web/src/app/admin/page.tsx | auth |
