...
| appCompletionGaps | 66 |
| indexedAppCompletionGaps | 66 |
| knownAppCompletionRiskItems | 66 |
| appCompletionPriorityReviewItems | 66 |
...
- medium: Account access: USE /market-stream has app-completion risk missing_doc_link.
...
| --- | --- | --- | --- | --- |
| medium | app_completion_gap | Account access | Account access: USE /market-stream has app-completion risk missing_doc_link. | Docs Memory Lead + Project Manager |
