...
| Area | Evidence |
| --- | --- |
| Final scorecard | `docs/operations/v1-completion-scorecard-2026-05-14-final.md` |
| Final ledger | `docs/operations/v1-master-state-ledger-2026-05-14-final.md` |
| Final project index | `docs/operations/v1-project-index-2026-05-14-final.md` |
| Static scan | `docs/operations/v1-static-issue-scan-2026-05-14-final.md` |
| Handoff | `docs/operations/v1-final-handoff-packet-2026-05-14.md` |
| Positions production proof | `docs/operations/prod-positions-proof-2fc90a08-2026-05-14.md` |
| Security/Exchange production proof | `docs/operations/prod-security-exchange-proof-2fc90a08-2026-05-14.md` |
| UX/A11y/Mobile production proof | `docs/operations/prod-ux-a11y-mobile-proof-2fc90a08-2026-05-14.md` |
| UI module clickthrough | `docs/operations/prod-ui-module-clickthrough-2fc90a08-2026-05-14.md` |
| Protected ops release gate | `docs/operations/v1-release-gate-prod-457bce05-2026-05-14-full-ready.md` |
| Final preflight | `docs/operations/v1-final-preflight-457bce05-2026-05-14-ready.md` |
| Rollback proof | `docs/operations/v1-rollback-proof-prod-2026-05-14T01-00-18-225Z.md` |
| Restore drill | `docs/operations/v1-restore-drill-prod-2026-05-14T00-00-00-000Z.md` |
| LIVE/PAPER controlled readback | `docs/operations/prod-live-paper-simultaneous-runtime-readback-457bce05-2026-05-14.md` |
| LIVE/PAPER cleanup readback | `docs/operations/prod-live-paper-post-cleanup-readback-457bce05-2026-05-14.md` |
| Fixture action proof | `docs/operations/prod-fixture-action-proof-457bce05-2026-05-14.md` |
...
1. `docs/operations/v1-completion-scorecard-2026-05-14-final.md`
2. `docs/operations/v1-final-handoff-packet-2026-05-14.md`
3. this inventory
