...
| --- | --- | --- | --- | --- | --- |
| `AUD-BTR-004` | P1 | open freshness follow-up | Fresh production-safe disposable backtest/report fixture proof was not rerun. Historical production proof remains accepted for the 2026-05-14 deployment target. | `docs/operations/prod-fixture-action-proof-457bce05-2026-05-14.md`; this audit's local Web/API packs. | Refresh production-safe disposable backtest/report proof after future deployments. |
