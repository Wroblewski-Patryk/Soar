...
| `AUDIT-HANDOFF-CHECK` | `corepack pnpm run audit:handoff:check` | `scripts/checkFullReusableAuditHandoff.mjs` | Validate full reusable audit handoff source paths, rollup summary parity, residual risks, forbidden boundaries, required validation checks including its self-check, and safety booleans. |
