# V1 Operator Unblock Packet (dd1a1faf / 2026-05-20)
...
- Build-info readback time: `2026-05-20T20:56:14.532Z`
...
- Final release readiness: blocked until protected production inputs and fresh
  same-date approval evidence exist
...
- Missing current production restore drill evidence for 2026-05-20.
- Missing current rollback proof PASS evidence for 2026-05-20.
- Activation audit, activation plan, RC status, RC sign-off, RC checklist,
  `LIVEIMPORT-03`, UI clickthrough, backup/restore, and rollback evidence are
  stale for the 2026-05-20 evidence date.
...
pnpm run ops:protected-inputs:check -- --today $releaseDate --expected-sha $expectedSha --json-output "docs/operations/v1-protected-input-readiness-$expectedShaShort-$releaseDate.json" --markdown-output "docs/operations/v1-protected-input-readiness-$expectedShaShort-$releaseDate.md"
```
