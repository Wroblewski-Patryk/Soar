...
| No-secret final preflight | BLOCKED | `docs/operations/v1-final-preflight-e8cd748e-2026-05-09.md` | Public checks pass, protected/formal evidence is missing. |
| Authenticated dashboard/admin UI | BLOCKED | `docs/planning/prod-ui-module-clickthrough-audit-plan-2026-05-08.md` | Needs production user/admin access and representative data. |
...
| Gate.io authenticated reads | partial | API-key probe and balance preview yes; remaining reads fail closed | n/a | n/a | `API_KEY_PROBE` and `BALANCE_PREVIEW` are implemented; implement positions/open-orders/trade-history snapshots if in scope. |
...
3. **Run the final blocker pack in order.**
   Use `docs/operations/v1-final-blocker-execution-pack-2026-05-07.md`.
4. **Run authenticated production UI clickthrough.**
   Use `docs/planning/prod-ui-module-clickthrough-audit-plan-2026-05-08.md`.
