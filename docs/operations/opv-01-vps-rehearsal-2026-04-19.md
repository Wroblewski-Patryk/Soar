...
## Evidence Artifacts
- Combined summary JSON: `docs/operations/_artifacts-opv-01-vps-rehearsal-2026-04-19T03-25-24.json`
- Docker rehearsal JSON: `docs/operations/_artifacts-opv-01-docker-rehearsal-2026-04-19T03-21-03.json`
- Docker rehearsal log: `docs/operations/_artifacts-opv-01-docker-rehearsal-2026-04-19T03-21-03.log`
- Production smoke log: `docs/operations/_artifacts-opv-01-smoke-prod-2026-04-19T03-25-24.log`
- Stage smoke log: `docs/operations/_artifacts-opv-01-smoke-stage-2026-04-19T03-25-24.log`
