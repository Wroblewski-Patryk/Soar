...
node scripts\runV1FinalPreflight.mjs --web-base-url https://soar.luckysparrow.ch --api-base-url https://api.soar.luckysparrow.ch --expected-sha 1dc55d9623bab11dacb5b9f8ce9634778c139249 --today 2026-05-09 --json-output docs/operations/_artifacts-v1-final-preflight-1dc55d96-2026-05-09.json --markdown-output docs/operations/v1-final-preflight-1dc55d96-2026-05-09.md
```
