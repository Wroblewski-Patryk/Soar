...
| --- | --- | --- | --- | --- | --- |
| `AUD-ADM-004` | P1 | open freshness follow-up | Fresh production protected admin/subscription route proof was not rerun. Historical production UI module proof remains accepted for the 2026-05-14 deployment target. | `docs/operations/prod-ui-module-clickthrough-2fc90a08-2026-05-14.md`; this audit's local Web/API packs. | Refresh production-safe protected admin route proof after future deployments. |
