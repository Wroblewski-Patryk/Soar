...
- `pnpm run ops:rc:gates:evidence:check -- --json --output docs/operations/_artifacts-opv-03-rc-evidence-final-sync-2026-04-19T01-43-32-327Z.json --require-production-gate2`
...
## Evidence Artifacts
- SLO raw artifact: `docs/operations/_artifacts-slo-window-2026-04-19T01-35-51-340Z.json`
- SLO observation report: `docs/operations/v1-slo-observation-2026-04-19T01-35-51-340Z.md`
- SLO window reports:
  - `docs/operations/v1-slo-window-report-7d-2026-04-19T01-36-24-775Z.json`
  - `docs/operations/v1-slo-window-report-30d-2026-04-19T01-36-25-355Z.json`
- RC evidence diagnostics:
  - `docs/operations/_artifacts-opv-03-rc-evidence-final-sync-2026-04-19T01-43-32-327Z.json`
- Command logs:
  - `docs/operations/_artifacts-opv-03-rc-window-refresh-2026-04-19T01-36-24-190Z.log`
  - `docs/operations/_artifacts-opv-03-final-sync-2026-04-19T01-43-32-327Z.log`
