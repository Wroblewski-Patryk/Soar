...
| --- | --- | --- | --- | --- |
| agent | implemented | Agent Checklists | .agents/checklists/README.md |  |
| agent | implemented | Anti-Regression System | .agents/core/anti-regression.md |  |
| agent | blocked | Execution Loop | .agents/core/execution-loop.md |  |
| agent | implemented | Mission Control | .agents/core/mission-control.md |  |
| agent | implemented | Agent Operating System | .agents/core/operating-system.md |  |
| agent | implemented | Product Delivery System | .agents/core/product-delivery-system.md |  |
| agent | implemented | Product Intake And Decision Handshake | .agents/core/product-intake-and-decision-handshake.md |  |
| agent | implemented | Project Memory Index | .agents/core/project-memory-index.md |  |
| agent | implemented | Quality Gates | .agents/core/quality-gates.md |  |
| agent | blocked | Requirements Verification System | .agents/core/requirements-verification-system.md |  |
| agent | blocked | backend-builder | .agents/prompts/backend-builder.md |  |
| agent | implemented | code-reviewer | .agents/prompts/code-reviewer.md |  |
| agent | implemented | db-migrations | .agents/prompts/db-migrations.md |  |
| agent | implemented | frontend-builder | .agents/prompts/frontend-builder.md |  |
| agent | implemented | ops-release | .agents/prompts/ops-release.md |  |
| agent | implemented | planner | .agents/prompts/planner.md |  |
| agent | implemented | product-docs | .agents/prompts/product-docs.md |  |
| agent | blocked | qa-test | .agents/prompts/qa-test.md |  |
| agent | implemented | security-auditor | .agents/prompts/security-auditor.md |  |
| agent | implemented | Agent Reports | .agents/reports/README.md |  |
| agent | implemented | Procedure | .agents/skills/_templates/SKILL.template.md |  |
| agent | blocked | Adopt Template Into Existing Project | .agents/skills/adopt_template_into_existing_project/SKILL.md |  |
| agent | implemented | Procedure | .agents/skills/build_worker_job_pipeline/SKILL.md |  |
| agent | implemented | Capture Agent Learnings | .agents/skills/capture-agent-learnings/SKILL.md |  |
| agent | implemented | Procedure | .agents/skills/implement_exchange_api_key_flow/SKILL.md |  |
| agent | implemented | Skills Index | .agents/skills/README.md |  |
| agent | implemented | Procedure | .agents/skills/run_release_gate_checks/SKILL.md |  |
| agent | implemented | Procedure | .agents/skills/scaffold_api_module/SKILL.md |  |
| agent | implemented | Procedure | .agents/skills/ship_dashboard_feature_slice/SKILL.md |  |
| agent | blocked | Active Mission Packet | .agents/state/active-mission.md |  |
| agent | blocked | Agent Process Evals | .agents/state/agent-evals.md |  |
| agent | implemented | Current Focus | .agents/state/current-focus.md |  |
| agent | implemented | Decision Register | .agents/state/decision-register.md |  |
| agent | blocked | Delivery Map | .agents/state/delivery-map.md |  |
| agent | implemented | Known Issues | .agents/state/known-issues.md |  |
| agent | blocked | Module Confidence Ledger | .agents/state/module-confidence-ledger.md |  |
| agent | blocked | Next Steps | .agents/state/next-steps.md |  |
| agent | implemented | Quality Attribute Scenarios | .agents/state/quality-attribute-scenarios.md |  |
| agent | implemented | Regression Log | .agents/state/regression-log.md |  |
| agent | blocked | Requirements Verification Matrix | .agents/state/requirements-verification-matrix.md |  |
| agent | implemented | Responsibility Learning | .agents/state/responsibility-learning.md |  |
| agent | implemented | Risk Register | .agents/state/risk-register.md |  |
| agent | implemented | System Health | .agents/state/system-health.md |  |
| agent | implemented | Agent Tasks | .agents/tasks/README.md |  |
| agent | blocked | Agent Hierarchy | .agents/workflows/agent-hierarchy.md |  |
| agent | implemented | Codex Power Use Workflow | .agents/workflows/codex-power-use.md |  |
| agent | implemented | Documentation Governance Workflow | .agents/workflows/documentation-governance.md |  |
| agent | implemented | General Workspace Rules | .agents/workflows/general.md |  |
| agent | implemented | Responsibility Lanes | .agents/workflows/responsibility-lanes.md |  |
| agent | blocked | Subagent Orchestration Workflow | .agents/workflows/subagent-orchestration.md |  |
| agent | implemented | User Collaboration Workflow | .agents/workflows/user-collaboration.md |  |
| agent | implemented | World-Class Delivery Workflow | .agents/workflows/world-class-delivery.md |  |
| agent | blocked | backend-builder.agent | .claude/agents/backend-builder.agent.md |  |
| agent | blocked | db-migrations.agent | .claude/agents/db-migrations.agent.md |  |
| agent | implemented | frontend-builder.agent | .claude/agents/frontend-builder.agent.md |  |
| agent | implemented | ops-release.agent | .claude/agents/ops-release.agent.md |  |
| agent | implemented | planner.agent | .claude/agents/planner.agent.md |  |
| agent | implemented | product-docs.agent | .claude/agents/product-docs.agent.md |  |
| agent | blocked | qa-test.agent | .claude/agents/qa-test.agent.md |  |
| agent | implemented | security-auditor.agent | .claude/agents/security-auditor.agent.md |  |
| agent | blocked | AI Red Team Agent | .codex/agents/ai-red-team-agent.md |  |
| agent | implemented | Documentation Agent | .codex/agents/documentation-agent.md |  |
| agent | implemented | Execution Agent | .codex/agents/execution-agent.md |  |
| agent | implemented | Planning Agent | .codex/agents/planning-agent.md |  |
| agent | implemented | Review Agent | .codex/agents/review-agent.md |  |
| api_endpoint | implemented | USE /avatars | apps/api/src/index.ts#/avatars |  |
| api_endpoint | implemented | GET / | apps/api/src/modules/admin/subscriptionPlans/subscriptionPlans.routes.ts#/ |  |
| api_endpoint | implemented | PUT /:code | apps/api/src/modules/admin/subscriptionPlans/subscriptionPlans.routes.ts#/:code |  |
| api_endpoint | implemented | GET / | apps/api/src/modules/admin/users/users.routes.ts#/ |  |
| api_endpoint | implemented | PATCH /:userId | apps/api/src/modules/admin/users/users.routes.ts#/:userId |  |
| api_endpoint | implemented | POST /login | apps/api/src/modules/auth/auth.routes.ts#/login |  |
| api_endpoint | implemented | POST /logout | apps/api/src/modules/auth/auth.routes.ts#/logout |  |
| api_endpoint | implemented | GET /me | apps/api/src/modules/auth/auth.routes.ts#/me |  |
| api_endpoint | implemented | POST /register | apps/api/src/modules/auth/auth.routes.ts#/register |  |
| api_endpoint | implemented | GET /runs | apps/api/src/modules/backtests/backtests.routes.ts#/runs |  |
| api_endpoint | implemented | POST /runs | apps/api/src/modules/backtests/backtests.routes.ts#/runs |  |
| api_endpoint | implemented | GET /runs/:id | apps/api/src/modules/backtests/backtests.routes.ts#/runs/:id |  |
| api_endpoint | implemented | DELETE /runs/:id | apps/api/src/modules/backtests/backtests.routes.ts#/runs/:id |  |
| api_endpoint | implemented | GET /runs/:id/report | apps/api/src/modules/backtests/backtests.routes.ts#/runs/:id/report |  |
| api_endpoint | implemented | GET /runs/:id/timeline | apps/api/src/modules/backtests/backtests.routes.ts#/runs/:id/timeline |  |
| api_endpoint | implemented | GET /runs/:id/trades | apps/api/src/modules/backtests/backtests.routes.ts#/runs/:id/trades |  |
| api_endpoint | implemented | POST /auth/register | apps/api/src/modules/bots/bots.e2e.shared.ts#/auth/register |  |
| api_endpoint | implemented | POST /dashboard/strategies | apps/api/src/modules/bots/bots.e2e.shared.ts#/dashboard/strategies |  |
| api_endpoint | implemented | GET / | apps/api/src/modules/bots/bots.routes.ts#/ |  |
| api_endpoint | implemented | POST / | apps/api/src/modules/bots/bots.routes.ts#/ |  |
| api_endpoint | implemented | GET /:id | apps/api/src/modules/bots/bots.routes.ts#/:id |  |
| api_endpoint | implemented | PUT /:id | apps/api/src/modules/bots/bots.routes.ts#/:id |  |
| api_endpoint | implemented | DELETE /:id | apps/api/src/modules/bots/bots.routes.ts#/:id |  |
| api_endpoint | implemented | GET /:id/assistant-config | apps/api/src/modules/bots/bots.routes.ts#/:id/assistant-config |  |
| api_endpoint | implemented | PUT /:id/assistant-config | apps/api/src/modules/bots/bots.routes.ts#/:id/assistant-config |  |
| api_endpoint | implemented | POST /:id/assistant-config/dry-run | apps/api/src/modules/bots/bots.routes.ts#/:id/assistant-config/dry-run |  |
| api_endpoint | implemented | PUT /:id/assistant-config/subagents/:slotIndex | apps/api/src/modules/bots/bots.routes.ts#/:id/assistant-config/subagents/:slotIndex |  |
| api_endpoint | implemented | DELETE /:id/assistant-config/subagents/:slotIndex | apps/api/src/modules/bots/bots.routes.ts#/:id/assistant-config/subagents/:slotIndex |  |
| api_endpoint | implemented | GET /:id/market-groups | apps/api/src/modules/bots/bots.routes.ts#/:id/market-groups |  |
| api_endpoint | implemented | POST /:id/market-groups | apps/api/src/modules/bots/bots.routes.ts#/:id/market-groups |  |
| api_endpoint | implemented | GET /:id/market-groups/:groupId | apps/api/src/modules/bots/bots.routes.ts#/:id/market-groups/:groupId |  |
| api_endpoint | implemented | PUT /:id/market-groups/:groupId | apps/api/src/modules/bots/bots.routes.ts#/:id/market-groups/:groupId |  |
| api_endpoint | implemented | DELETE /:id/market-groups/:groupId | apps/api/src/modules/bots/bots.routes.ts#/:id/market-groups/:groupId |  |
| api_endpoint | implemented | GET /:id/market-groups/:groupId/strategies | apps/api/src/modules/bots/bots.routes.ts#/:id/market-groups/:groupId/strategies |  |
| api_endpoint | implemented | POST /:id/market-groups/:groupId/strategies | apps/api/src/modules/bots/bots.routes.ts#/:id/market-groups/:groupId/strategies |  |
| api_endpoint | implemented | PUT /:id/market-groups/:groupId/strategies/:linkId | apps/api/src/modules/bots/bots.routes.ts#/:id/market-groups/:groupId/strategies/:linkId |  |
| api_endpoint | implemented | DELETE /:id/market-groups/:groupId/strategies/:linkId | apps/api/src/modules/bots/bots.routes.ts#/:id/market-groups/:groupId/strategies/:linkId |  |
| api_endpoint | implemented | PUT /:id/market-groups/:groupId/strategies/reorder | apps/api/src/modules/bots/bots.routes.ts#/:id/market-groups/:groupId/strategies/reorder |  |
| api_endpoint | implemented | GET /:id/portfolio-history | apps/api/src/modules/bots/bots.routes.ts#/:id/portfolio-history |  |
| api_endpoint | implemented | GET /:id/runtime-graph | apps/api/src/modules/bots/bots.routes.ts#/:id/runtime-graph |  |
| api_endpoint | implemented | GET /:id/runtime-monitoring/aggregate | apps/api/src/modules/bots/bots.routes.ts#/:id/runtime-monitoring/aggregate |  |
| api_endpoint | implemented | GET /:id/runtime-sessions | apps/api/src/modules/bots/bots.routes.ts#/:id/runtime-sessions |  |
| api_endpoint | implemented | GET /:id/runtime-sessions/:sessionId | apps/api/src/modules/bots/bots.routes.ts#/:id/runtime-sessions/:sessionId |  |
| api_endpoint | implemented | GET /:id/runtime-sessions/:sessionId/positions | apps/api/src/modules/bots/bots.routes.ts#/:id/runtime-sessions/:sessionId/positions |  |
| api_endpoint | implemented | POST /:id/runtime-sessions/:sessionId/positions/:positionId/close | apps/api/src/modules/bots/bots.routes.ts#/:id/runtime-sessions/:sessionId/positions/:positionId/close |  |
| api_endpoint | implemented | GET /:id/runtime-sessions/:sessionId/symbol-stats | apps/api/src/modules/bots/bots.routes.ts#/:id/runtime-sessions/:sessionId/symbol-stats |  |
| api_endpoint | implemented | GET /:id/runtime-sessions/:sessionId/trades | apps/api/src/modules/bots/bots.routes.ts#/:id/runtime-sessions/:sessionId/trades |  |
| api_endpoint | implemented | GET /strategy-drift | apps/api/src/modules/bots/bots.routes.ts#/strategy-drift |  |
| api_endpoint | implemented | POST /strategy-drift/repair | apps/api/src/modules/bots/bots.routes.ts#/strategy-drift/repair |  |
| api_endpoint | implemented | GET /lookup | apps/api/src/modules/icons/icons.routes.ts#/lookup |  |
| api_endpoint | implemented | GET / | apps/api/src/modules/logs/logs.routes.ts#/ |  |
| api_endpoint | implemented | GET market:${cacheKey} | apps/api/src/modules/market-data/marketData.service.ts#market:${cacheKey} |  |
| api_endpoint | implemented | GET /events | apps/api/src/modules/market-stream/marketStream.routes.ts#/events |  |
| api_endpoint | implemented | GET /catalog | apps/api/src/modules/markets/markets.routes.ts#/catalog |  |
| api_endpoint | implemented | GET /universes | apps/api/src/modules/markets/markets.routes.ts#/universes |  |
| api_endpoint | implemented | POST /universes | apps/api/src/modules/markets/markets.routes.ts#/universes |  |
| api_endpoint | implemented | GET /universes/:id | apps/api/src/modules/markets/markets.routes.ts#/universes/:id |  |
| api_endpoint | implemented | PUT /universes/:id | apps/api/src/modules/markets/markets.routes.ts#/universes/:id |  |
| api_endpoint | implemented | DELETE /universes/:id | apps/api/src/modules/markets/markets.routes.ts#/universes/:id |  |
| api_endpoint | implemented | GET / | apps/api/src/modules/orders/orders.routes.ts#/ |  |
| api_endpoint | implemented | GET /:id | apps/api/src/modules/orders/orders.routes.ts#/:id |  |
| api_endpoint | implemented | POST /:id/cancel | apps/api/src/modules/orders/orders.routes.ts#/:id/cancel |  |
| api_endpoint | implemented | POST /:id/close | apps/api/src/modules/orders/orders.routes.ts#/:id/close |  |
| api_endpoint | implemented | GET /manual-context | apps/api/src/modules/orders/orders.routes.ts#/manual-context |  |
| api_endpoint | implemented | POST /open | apps/api/src/modules/orders/orders.routes.ts#/open |  |
| api_endpoint | implemented | GET / | apps/api/src/modules/positions/positions.routes.ts#/ |  |
| api_endpoint | implemented | GET /:id | apps/api/src/modules/positions/positions.routes.ts#/:id |  |
| api_endpoint | implemented | PATCH /:id/management-mode | apps/api/src/modules/positions/positions.routes.ts#/:id/management-mode |  |
| api_endpoint | implemented | PATCH /:id/manual-update | apps/api/src/modules/positions/positions.routes.ts#/:id/manual-update |  |
| api_endpoint | implemented | GET /exchange-snapshot | apps/api/src/modules/positions/positions.routes.ts#/exchange-snapshot |  |
| api_endpoint | implemented | GET /live-status | apps/api/src/modules/positions/positions.routes.ts#/live-status |  |
| api_endpoint | implemented | POST /orphan-repair | apps/api/src/modules/positions/positions.routes.ts#/orphan-repair |  |
| api_endpoint | implemented | POST /takeover-rebind | apps/api/src/modules/positions/positions.routes.ts#/takeover-rebind |  |
| api_endpoint | implemented | GET /takeover-status | apps/api/src/modules/positions/positions.routes.ts#/takeover-status |  |
| api_endpoint | implemented | ROUTE / | apps/api/src/modules/profile/apiKey/apiKey.routes.ts#/ |  |
| api_endpoint | implemented | ROUTE /:id | apps/api/src/modules/profile/apiKey/apiKey.routes.ts#/:id |  |
| api_endpoint | implemented | POST /:id/revoke | apps/api/src/modules/profile/apiKey/apiKey.routes.ts#/:id/revoke |  |
| api_endpoint | implemented | POST /:id/rotate | apps/api/src/modules/profile/apiKey/apiKey.routes.ts#/:id/rotate |  |
| api_endpoint | implemented | POST /:id/test | apps/api/src/modules/profile/apiKey/apiKey.routes.ts#/:id/test |  |
| api_endpoint | implemented | POST /test | apps/api/src/modules/profile/apiKey/apiKey.routes.ts#/test |  |
| api_endpoint | implemented | ROUTE / | apps/api/src/modules/profile/basic/basic.routes.ts#/ |  |
| api_endpoint | implemented | DELETE /account | apps/api/src/modules/profile/security/security.routes.ts#/account |  |
| api_endpoint | implemented | PATCH /password | apps/api/src/modules/profile/security/security.routes.ts#/password |  |
| api_endpoint | implemented | GET / | apps/api/src/modules/profile/subscription/subscription.routes.ts#/ |  |
| api_endpoint | implemented | POST /checkout-intents | apps/api/src/modules/profile/subscription/subscription.routes.ts#/checkout-intents |  |
| api_endpoint | implemented | GET /cross-mode-performance | apps/api/src/modules/reports/reports.routes.ts#/cross-mode-performance |  |
| api_endpoint | implemented | ROUTE / | apps/api/src/modules/strategies/indicators/indicators.routes.ts#/ |  |
| api_endpoint | implemented | GET / | apps/api/src/modules/strategies/strategies.routes.ts#/ |  |
| api_endpoint | implemented | POST / | apps/api/src/modules/strategies/strategies.routes.ts#/ |  |
| api_endpoint | implemented | GET /:id | apps/api/src/modules/strategies/strategies.routes.ts#/:id |  |
| api_endpoint | implemented | PUT /:id | apps/api/src/modules/strategies/strategies.routes.ts#/:id |  |
| api_endpoint | implemented | DELETE /:id | apps/api/src/modules/strategies/strategies.routes.ts#/:id |  |
| api_endpoint | implemented | GET /:id/export | apps/api/src/modules/strategies/strategies.routes.ts#/:id/export |  |
| api_endpoint | implemented | POST /import | apps/api/src/modules/strategies/strategies.routes.ts#/import |  |
| api_endpoint | implemented | USE /indicators | apps/api/src/modules/strategies/strategies.routes.ts#/indicators |  |
| api_endpoint | implemented | POST /avatar | apps/api/src/modules/upload/upload.routes.ts#/avatar |  |
| api_endpoint | implemented | GET / | apps/api/src/modules/wallets/wallets.routes.ts#/ |  |
| api_endpoint | implemented | POST / | apps/api/src/modules/wallets/wallets.routes.ts#/ |  |
| api_endpoint | implemented | GET /:id | apps/api/src/modules/wallets/wallets.routes.ts#/:id |  |
| api_endpoint | implemented | PUT /:id | apps/api/src/modules/wallets/wallets.routes.ts#/:id |  |
| api_endpoint | implemented | DELETE /:id | apps/api/src/modules/wallets/wallets.routes.ts#/:id |  |
| api_endpoint | implemented | GET /:id/cashflow-events | apps/api/src/modules/wallets/wallets.routes.ts#/:id/cashflow-events |  |
| api_endpoint | implemented | GET /:id/equity-timeline | apps/api/src/modules/wallets/wallets.routes.ts#/:id/equity-timeline |  |
| api_endpoint | implemented | GET /:id/performance-summary | apps/api/src/modules/wallets/wallets.routes.ts#/:id/performance-summary |  |
| api_endpoint | implemented | POST /:id/reset-paper | apps/api/src/modules/wallets/wallets.routes.ts#/:id/reset-paper |  |
| api_endpoint | implemented | GET /metadata | apps/api/src/modules/wallets/wallets.routes.ts#/metadata |  |
| api_endpoint | implemented | POST /preview-balance | apps/api/src/modules/wallets/wallets.routes.ts#/preview-balance |  |
| api_endpoint | implemented | GET / | apps/api/src/router/admin.routes.ts#/ |  |
| api_endpoint | implemented | USE /subscriptions/plans | apps/api/src/router/admin.routes.ts#/subscriptions/plans |  |
| api_endpoint | implemented | USE /users | apps/api/src/router/admin.routes.ts#/users |  |
| api_endpoint | implemented | GET / | apps/api/src/router/dashboard.routes.ts#/ |  |
| api_endpoint | implemented | USE /backtests | apps/api/src/router/dashboard.routes.ts#/backtests |  |
| api_endpoint | implemented | USE /bots | apps/api/src/router/dashboard.routes.ts#/bots |  |
| api_endpoint | implemented | USE /icons | apps/api/src/router/dashboard.routes.ts#/icons |  |
| api_endpoint | implemented | USE /logs | apps/api/src/router/dashboard.routes.ts#/logs |  |
| api_endpoint | implemented | USE /market-stream | apps/api/src/router/dashboard.routes.ts#/market-stream |  |
| api_endpoint | implemented | USE /markets | apps/api/src/router/dashboard.routes.ts#/markets |  |
| api_endpoint | implemented | USE /orders | apps/api/src/router/dashboard.routes.ts#/orders |  |
| api_endpoint | implemented | USE /positions | apps/api/src/router/dashboard.routes.ts#/positions |  |
| api_endpoint | implemented | USE /profile/apiKeys | apps/api/src/router/dashboard.routes.ts#/profile/apiKeys |  |
| api_endpoint | implemented | USE /profile/basic | apps/api/src/router/dashboard.routes.ts#/profile/basic |  |
| api_endpoint | implemented | USE /profile/security | apps/api/src/router/dashboard.routes.ts#/profile/security |  |
| api_endpoint | implemented | USE /profile/subscription | apps/api/src/router/dashboard.routes.ts#/profile/subscription |  |
| api_endpoint | implemented | USE /reports | apps/api/src/router/dashboard.routes.ts#/reports |  |
| api_endpoint | implemented | USE /strategies | apps/api/src/router/dashboard.routes.ts#/strategies |  |
| api_endpoint | implemented | USE /wallets | apps/api/src/router/dashboard.routes.ts#/wallets |  |
| api_endpoint | implemented | GET / | apps/api/src/router/index.ts#/ |  |
| api_endpoint | implemented | USE /admin | apps/api/src/router/index.ts#/admin |  |
| api_endpoint | implemented | GET /alerts | apps/api/src/router/index.ts#/alerts |  |
| api_endpoint | implemented | USE /auth | apps/api/src/router/index.ts#/auth |  |
| api_endpoint | implemented | USE /dashboard | apps/api/src/router/index.ts#/dashboard |  |
| api_endpoint | implemented | GET /health | apps/api/src/router/index.ts#/health |  |
| api_endpoint | implemented | GET /metrics | apps/api/src/router/index.ts#/metrics |  |
| api_endpoint | implemented | GET /ready | apps/api/src/router/index.ts#/ready |  |
| api_endpoint | implemented | GET /ready/details | apps/api/src/router/index.ts#/ready/details |  |
| api_endpoint | implemented | USE /upload | apps/api/src/router/index.ts#/upload |  |
| api_endpoint | implemented | GET /workers/health | apps/api/src/router/index.ts#/workers/health |  |
| api_endpoint | implemented | GET /workers/ready | apps/api/src/router/index.ts#/workers/ready |  |
| api_endpoint | implemented | GET /workers/runtime-freshness | apps/api/src/router/index.ts#/workers/runtime-freshness |  |
| api_endpoint | implemented | POST /auth/logout | apps/web/src/context/AuthContext.tsx#/auth/logout |  |
| api_endpoint | implemented | GET /auth/me | apps/web/src/context/AuthContext.tsx#/auth/me |  |
| api_endpoint | implemented | GET session | apps/web/src/context/AuthContext.tsx#session |  |
| api_endpoint | implemented | DELETE session | apps/web/src/context/AuthContext.tsx#session |  |
| api_endpoint | implemented | POST /auth/login | apps/web/src/features/auth/services/auth.service.ts#/auth/login |  |
| api_endpoint | implemented | POST /auth/register | apps/web/src/features/auth/services/auth.service.ts#/auth/register |  |
| api_endpoint | implemented | DELETE /dashboard/backtests/runs/${runId} | apps/web/src/features/backtest/services/backtests.service.ts#/dashboard/backtests/runs/${runId} |  |
| api_endpoint | implemented | DELETE /dashboard/bots/${botId}/assistant-config/subagents/${slotIndex} | apps/web/src/features/bots/services/bots.service.ts#/dashboard/bots/${botId}/assistant-config/subagents/${slotIndex} |  |
| api_endpoint | implemented | DELETE /dashboard/bots/${id} | apps/web/src/features/bots/services/bots.service.ts#/dashboard/bots/${id} |  |
| api_endpoint | implemented | DELETE /dashboard/markets/universes/${id} | apps/web/src/features/markets/services/markets.service.ts#/dashboard/markets/universes/${id} |  |
| api_endpoint | implemented | POST /upload/avatar | apps/web/src/features/profile/components/BasicForm.tsx#/upload/avatar |  |
| api_endpoint | implemented | DELETE ${API}/${id} | apps/web/src/features/profile/services/apiKeys.service.ts#${API}/${id} |  |
| api_endpoint | implemented | POST ${API}/${id}/test | apps/web/src/features/profile/services/apiKeys.service.ts#${API}/${id}/test |  |
| api_endpoint | implemented | POST ${API}/test | apps/web/src/features/profile/services/apiKeys.service.ts#${API}/test |  |
| api_endpoint | implemented | DELETE /dashboard/profile/security/account | apps/web/src/features/profile/services/security.service.ts#/dashboard/profile/security/account |  |
| api_endpoint | implemented | PATCH /dashboard/profile/security/password | apps/web/src/features/profile/services/security.service.ts#/dashboard/profile/security/password |  |
| api_endpoint | implemented | DELETE /dashboard/strategies/${id} | apps/web/src/features/strategies/api/strategies.api.ts#/dashboard/strategies/${id} |  |
| api_endpoint | implemented | DELETE /dashboard/wallets/${id} | apps/web/src/features/wallets/services/wallets.service.ts#/dashboard/wallets/${id} |  |
| api_endpoint | implemented | GET cookie | apps/web/src/middleware.ts#cookie |  |
| api_endpoint | implemented | GET /auth/me | apps/web/src/ui/layout/dashboard/SafetyBar.tsx#/auth/me |  |
| api_endpoint | implemented | GET production | scripts/buildSloWindowReport.mjs#production |  |
| api_endpoint | implemented | GET content-type | scripts/deploySmokeCheck.mjs#content-type |  |
| api_endpoint | implemented | GET cache-control | scripts/runProdSecurityExchangeProof.mjs#cache-control |  |
| api_endpoint | implemented | GET pragma | scripts/runProdSecurityExchangeProof.mjs#pragma |  |
| api_endpoint | implemented | GET x-content-type-options | scripts/runProdSecurityExchangeProof.mjs#x-content-type-options |  |
| api_endpoint | implemented | GET x-frame-options | scripts/runProdSecurityExchangeProof.mjs#x-frame-options |  |
| api_endpoint | implemented | GET location | scripts/runProdUiModuleClickthroughAudit.mjs#location |  |
| api_endpoint | implemented | GET backupRestoreDrill | scripts/runV1FinalPreflight.mjs#backupRestoreDrill |  |
| component | implemented | AuthContext.tsx | apps/web/src/context/AuthContext.tsx |  |
| component | implemented | AdminLayoutShell.tsx | apps/web/src/features/admin/layout/AdminLayoutShell.tsx |  |
| component | implemented | LoginForm.tsx | apps/web/src/features/auth/components/LoginForm.tsx |  |
| component | implemented | PasswordVisibilityToggle.tsx | apps/web/src/features/auth/components/PasswordVisibilityToggle.tsx |  |
| component | implemented | RegisterForm.tsx | apps/web/src/features/auth/components/RegisterForm.tsx |  |
| component | implemented | BacktestCreateForm.tsx | apps/web/src/features/backtest/components/BacktestCreateForm.tsx |  |
| component | implemented | BacktestRunDetails.tsx | apps/web/src/features/backtest/components/BacktestRunDetails.tsx |  |
| component | implemented | backtestRunDetailsCharts.tsx | apps/web/src/features/backtest/components/backtestRunDetailsCharts.tsx |  |
| component | implemented | BacktestRunDetailsTabPanels.tsx | apps/web/src/features/backtest/components/BacktestRunDetailsTabPanels.tsx |  |
| component | implemented | BacktestRunHeaderSection.tsx | apps/web/src/features/backtest/components/BacktestRunHeaderSection.tsx |  |
| component | implemented | BacktestsList.tsx | apps/web/src/features/backtest/components/BacktestsList.tsx |  |
| component | implemented | BacktestsListView.tsx | apps/web/src/features/backtest/components/BacktestsListView.tsx |  |
| component | implemented | BacktestsRunsTable.tsx | apps/web/src/features/backtest/components/BacktestsRunsTable.tsx |  |
| component | implemented | BotCreateEditForm.tsx | apps/web/src/features/bots/components/BotCreateEditForm.tsx |  |
| component | implemented | BotsManagementTabs.tsx | apps/web/src/features/bots/components/bots-management/BotsManagementTabs.tsx |  |
| component | implemented | BotsMonitoringAttributionPills.tsx | apps/web/src/features/bots/components/bots-management/BotsMonitoringAttributionPills.tsx |  |
| component | implemented | BotsMonitoringProtectionCell.tsx | apps/web/src/features/bots/components/bots-management/BotsMonitoringProtectionCell.tsx |  |
| component | blocked | BotsMonitoringRuntimeStateCell.tsx | apps/web/src/features/bots/components/bots-management/BotsMonitoringRuntimeStateCell.tsx |  |
| component | implemented | BotsMonitoringSections.tsx | apps/web/src/features/bots/components/bots-management/BotsMonitoringSections.tsx |  |
| component | implemented | BotsMonitoringTab.tsx | apps/web/src/features/bots/components/bots-management/BotsMonitoringTab.tsx |  |
| component | implemented | BotsPortfolioHistorySection.tsx | apps/web/src/features/bots/components/bots-management/BotsPortfolioHistorySection.tsx |  |
| component | implemented | MonitoringFutureSignalsSection.tsx | apps/web/src/features/bots/components/bots-management/MonitoringFutureSignalsSection.tsx |  |
| component | implemented | BotsAssistantTab.tsx | apps/web/src/features/bots/components/BotsAssistantTab.tsx |  |
| component | implemented | BotsListTable.tsx | apps/web/src/features/bots/components/BotsListTable.tsx |  |
| component | implemented | BotsManagement.tsx | apps/web/src/features/bots/components/BotsManagement.tsx |  |
| component | implemented | RuntimeDataSection.tsx | apps/web/src/features/dashboard-home/components/home-live-widgets/RuntimeDataSection.tsx |  |
| component | implemented | runtimeDataTablePresenters.tsx | apps/web/src/features/dashboard-home/components/home-live-widgets/runtimeDataTablePresenters.tsx |  |
| component | implemented | runtimeOnboardingConfig.tsx | apps/web/src/features/dashboard-home/components/home-live-widgets/runtimeOnboardingConfig.tsx |  |
| component | implemented | RuntimeOnboardingSection.tsx | apps/web/src/features/dashboard-home/components/home-live-widgets/RuntimeOnboardingSection.tsx |  |
| component | implemented | RuntimeSidebarSection.tsx | apps/web/src/features/dashboard-home/components/home-live-widgets/RuntimeSidebarSection.tsx |  |
| component | implemented | RuntimeSignalsSection.tsx | apps/web/src/features/dashboard-home/components/home-live-widgets/RuntimeSignalsSection.tsx |  |
| component | implemented | runtimeUiHelpers.tsx | apps/web/src/features/dashboard-home/components/home-live-widgets/runtimeUiHelpers.tsx |  |
| component | implemented | HomeLiveWidgets.tsx | apps/web/src/features/dashboard-home/components/HomeLiveWidgets.tsx |  |
| component | implemented | LiveMarketBar.tsx | apps/web/src/features/dashboard-home/components/LiveMarketBar.tsx |  |
| component | implemented | ExchangeConnectionsView.tsx | apps/web/src/features/exchanges/components/ExchangeConnectionsView.tsx |  |
| component | implemented | AuditTrailView.tsx | apps/web/src/features/logs/components/AuditTrailView.tsx |  |
| component | implemented | MarketUniverseForm.tsx | apps/web/src/features/markets/components/MarketUniverseForm.tsx |  |
| component | implemented | MarketUniversesTable.tsx | apps/web/src/features/markets/components/MarketUniversesTable.tsx |  |
| component | implemented | SearchableMultiSelect.tsx | apps/web/src/features/markets/components/SearchableMultiSelect.tsx |  |
| component | implemented | ApiKeyForm.tsx | apps/web/src/features/profile/components/ApiKeyForm.tsx |  |
| component | implemented | ApiKeysList.tsx | apps/web/src/features/profile/components/ApiKeysList.tsx |  |
| component | implemented | BasicForm.tsx | apps/web/src/features/profile/components/BasicForm.tsx |  |
| component | implemented | Security.tsx | apps/web/src/features/profile/components/Security.tsx |  |
| component | implemented | Subscription.tsx | apps/web/src/features/profile/components/Subscription.tsx |  |
| component | implemented | PerformanceReportsView.tsx | apps/web/src/features/reports/components/PerformanceReportsView.tsx |  |
| component | implemented | StrategiesList.tsx | apps/web/src/features/strategies/components/StrategiesList.tsx |  |
| component | implemented | StrategyForm.tsx | apps/web/src/features/strategies/components/StrategyForm.tsx |  |
| component | implemented | Additional.tsx | apps/web/src/features/strategies/components/StrategyFormSections/Additional.tsx |  |
| component | implemented | Basic.tsx | apps/web/src/features/strategies/components/StrategyFormSections/Basic.tsx |  |
| component | implemented | Close.tsx | apps/web/src/features/strategies/components/StrategyFormSections/Close.tsx |  |
| component | implemented | Indicators.tsx | apps/web/src/features/strategies/components/StrategyFormSections/Indicators.tsx |  |
| component | implemented | Open.tsx | apps/web/src/features/strategies/components/StrategyFormSections/Open.tsx |  |
| component | implemented | SortableThresholdListEditor.tsx | apps/web/src/features/strategies/components/StrategyFormSections/SortableThresholdListEditor.tsx |  |
| component | implemented | StrategyPresetPicker.tsx | apps/web/src/features/strategies/components/StrategyPresetPicker.tsx |  |
| component | implemented | sections.tsx | apps/web/src/features/wallets/components/wallet-create-edit-form/sections.tsx |  |
| component | implemented | WalletCreateEditForm.tsx | apps/web/src/features/wallets/components/WalletCreateEditForm.tsx |  |
| component | implemented | WalletPreviewPanel.tsx | apps/web/src/features/wallets/components/WalletPreviewPanel.tsx |  |
| component | implemented | WalletsListTable.tsx | apps/web/src/features/wallets/components/WalletsListTable.tsx |  |
| component | implemented | I18nProvider.tsx | apps/web/src/i18n/I18nProvider.tsx |  |
| component | implemented | AppLogoLink.tsx | apps/web/src/ui/components/AppLogoLink.tsx |  |
| component | implemented | AssetSymbol.tsx | apps/web/src/ui/components/AssetSymbol.tsx |  |
| component | implemented | ConfirmModal.tsx | apps/web/src/ui/components/ConfirmModal.tsx |  |
| component | implemented | DataTable.tsx | apps/web/src/ui/components/DataTable.tsx |  |
| component | implemented | FooterPreferencesSwitchers.tsx | apps/web/src/ui/components/FooterPreferencesSwitchers.tsx |  |
| component | implemented | FormModal.tsx | apps/web/src/ui/components/FormModal.tsx |  |
| component | implemented | InlinePager.tsx | apps/web/src/ui/components/InlinePager.tsx |  |
| component | implemented | SkeletonCardBlock.tsx | apps/web/src/ui/components/loading/SkeletonCardBlock.tsx |  |
| component | implemented | SkeletonFormBlock.tsx | apps/web/src/ui/components/loading/SkeletonFormBlock.tsx |  |
| component | implemented | SkeletonKpiRow.tsx | apps/web/src/ui/components/loading/SkeletonKpiRow.tsx |  |
| component | implemented | SkeletonTableRows.tsx | apps/web/src/ui/components/loading/SkeletonTableRows.tsx |  |
| component | implemented | ProfileButton.tsx | apps/web/src/ui/components/ProfileButton.tsx |  |
| component | implemented | SkipToContentLink.tsx | apps/web/src/ui/components/SkipToContentLink.tsx |  |
| component | implemented | StatusBadge.tsx | apps/web/src/ui/components/StatusBadge.tsx |  |
| component | implemented | TableUi.tsx | apps/web/src/ui/components/TableUi.tsx |  |
| component | implemented | Tabs.tsx | apps/web/src/ui/components/Tabs.tsx |  |
| component | implemented | ThemeSwitch.tsx | apps/web/src/ui/components/ThemeSwitch.tsx |  |
| component | implemented | useAsyncConfirm.tsx | apps/web/src/ui/components/useAsyncConfirm.tsx |  |
| component | implemented | ViewState.tsx | apps/web/src/ui/components/ViewState.tsx |  |
| component | implemented | FormAlert.tsx | apps/web/src/ui/forms/FormAlert.tsx |  |
| component | implemented | FormField.tsx | apps/web/src/ui/forms/FormField.tsx |  |
| component | implemented | FormFields.tsx | apps/web/src/ui/forms/FormFields.tsx |  |
| component | implemented | FormGrid.tsx | apps/web/src/ui/forms/FormGrid.tsx |  |
| component | implemented | FormMobileActionBar.tsx | apps/web/src/ui/forms/FormMobileActionBar.tsx |  |
| component | implemented | FormPageShell.tsx | apps/web/src/ui/forms/FormPageShell.tsx |  |
| component | implemented | FormSectionCard.tsx | apps/web/src/ui/forms/FormSectionCard.tsx |  |
| component | implemented | FormValidationSummary.tsx | apps/web/src/ui/forms/FormValidationSummary.tsx |  |
| component | implemented | DashboardRouteProgress.tsx | apps/web/src/ui/layout/dashboard/DashboardRouteProgress.tsx |  |
| component | implemented | Footer.tsx | apps/web/src/ui/layout/dashboard/Footer.tsx |  |
| component | implemented | Header.tsx | apps/web/src/ui/layout/dashboard/Header.tsx |  |
| component | implemented | IsometricModeToggle.tsx | apps/web/src/ui/layout/dashboard/IsometricModeToggle.tsx |  |
| component | implemented | LanguageSwitcher.tsx | apps/web/src/ui/layout/dashboard/LanguageSwitcher.tsx |  |
| component | implemented | PageTitle.tsx | apps/web/src/ui/layout/dashboard/PageTitle.tsx |  |
| component | implemented | RiskNoticeFooter.tsx | apps/web/src/ui/layout/dashboard/RiskNoticeFooter.tsx |  |
| component | implemented | SafetyBar.tsx | apps/web/src/ui/layout/dashboard/SafetyBar.tsx |  |
| component | implemented | Footer.tsx | apps/web/src/ui/layout/public/Footer.tsx |  |
| component | implemented | Header.tsx | apps/web/src/ui/layout/public/Header.tsx |  |
| component | implemented | ServiceWorkerRegistration.tsx | apps/web/src/ui/pwa/ServiceWorkerRegistration.tsx |  |
| document | blocked | LEARNING_JOURNAL | .codex/context/LEARNING_JOURNAL.md |  |
| document | blocked | PROJECT_STATE.md | .codex/context/PROJECT_STATE.md |  |
| document | implemented | TASK_BOARD | .codex/context/TASK_BOARD.md |  |
| document | blocked | App Blueprint | .codex/templates/app-blueprint-template.md |  |
| document | blocked | deployment-agent-checklist-template.md | .codex/templates/deployment-agent-checklist-template.md |  |
| document | blocked | Handoff Packet | .codex/templates/handoff-packet-template.md |  |
| document | implemented | Project State Update Template | .codex/templates/project-state-template.md |  |
| document | blocked | Task | .codex/templates/task-template.md |  |
| document | implemented | User Feedback Item | .codex/templates/user-feedback-item-template.md |  |
| document | implemented | pull_request_template.md | .github/pull_request_template.md |  |
| document | implemented | AGENTS.md - CryptoSparrow / Soar | AGENTS.md |  |
| document | implemented | AI Testing Protocol | AI_TESTING_PROTOCOL.md |  |
| document | implemented | CryptoSparrow Mobile (Bootstrap) | apps/mobile/README.md |  |
| document | implemented | or | apps/web/README.md |  |
| document | implemented | Changelog | CHANGELOG.md |  |
| document | blocked | Definition Of Done | DEFINITION_OF_DONE.md |  |
| document | blocked | Deployment Gate | DEPLOYMENT_GATE.md |  |
| document | implemented | ADR 0001: Agent Governance Baseline | docs/adr/0001-agent-governance-baseline.md |  |
| document | deprecated | ADR Index | docs/adr/architecture-decision-records.md |  |
| document | implemented | Analysis Documentation | docs/analysis/analysis-documentation.md |  |
| document | implemented | Documentation Drift Report | docs/analysis/documentation-drift.md |  |
| document | implemented | Documentation Inventory | docs/analysis/documentation-inventory.md |  |
| document | implemented | LUC-20 Docs/index/template feedback audit | docs/analysis/luc-20-docs-index-template-feedback-audit-2026-05-25.md |  |
| document | implemented | LUC-48 Autonomous map inventory and UI polish readiness gate | docs/analysis/luc-48-autonomous-map-inventory-and-ui-polish-readiness-gate-2026-05-25.md |  |
| document | implemented | LUC-49 UI state browser proof matrix | docs/analysis/luc-49-ui-state-browser-proof-matrix-2026-05-25.md |  |
| document | implemented | LUC-81 Docs And Memory Loop Audit | docs/analysis/luc-81-docs-memory-loop-2026-05-26.md |  |
| document | blocked | Reusable Audit Registry | docs/analysis/reusable-audit-registry.md |  |
| document | implemented | 01 Overview and Principles | docs/architecture/01_overview-and-principles.md |  |
| document | implemented | 02 System Topology | docs/architecture/02_system-topology.md |  |
| document | implemented | 03 Domain Model | docs/architecture/03_domain-model.md |  |
| document | implemented | 04 Runtime Contexts | docs/architecture/04_runtime-contexts.md |  |
| document | implemented | 05 Strategy, Signal, and Decision Flow | docs/architecture/05_strategy-signal-and-decision-flow.md |  |
| document | implemented | 06 Execution Lifecycle | docs/architecture/06_execution-lifecycle.md |  |
| document | implemented | 07 Modes, Parity, and Data | docs/architecture/07_modes-parity-and-data.md |  |
| document | implemented | 08 Operator Surfaces and Routing | docs/architecture/08_operator-surfaces-and-routing.md |  |
| document | implemented | 09 Integrations, Deployment, and Runtime Services | docs/architecture/09_integrations-deployment-and-runtime-services.md |  |
| document | blocked | 10 Safety, Entitlements, and Risk | docs/architecture/10_safety-entitlements-and-risk.md |  |
| document | implemented | 11 Assistant Runtime | docs/architecture/11_assistant-runtime.md |  |
| document | implemented | 12 Documentation Governance | docs/architecture/12_documentation-governance.md |  |
| document | implemented | Agent System Primitives | docs/architecture/agent-system-primitives.md |  |
| document | implemented | Architecture Documentation for Soar | docs/architecture/architecture-documentation.md |  |
| document | implemented | Architecture Evidence Graph System | docs/architecture/architecture-evidence-graph-system.md |  |
| document | implemented | Architecture Source Of Truth | docs/architecture/architecture-source-of-truth.md |  |
| document | implemented | Architecture Archive | docs/architecture/archive/architecture-archive.md |  |
| document | implemented | Bot V2 Create/Update Contract (Historical Compatibility Note) | docs/architecture/archive/bot-v2-create-update-contract.md |  |
| document | implemented | Database (Compatibility Stub) | docs/architecture/archive/database.md |  |
| document | implemented | Legacy CryptoBot Positions Module - Deep Analysis | docs/architecture/archive/legacy-cryptobot-positions-analysis.md |  |
| document | implemented | modules.md | docs/architecture/archive/modules.md |  |
| document | implemented | Runtime Critical-Path Decomposition Contract | docs/architecture/archive/runtime-critical-path-decomposition-contract.md |  |
| document | implemented | System Architecture (Compatibility Stub) | docs/architecture/archive/system-architecture.md |  |
| document | implemented | Tech Stack (Compatibility Stub) | docs/architecture/archive/tech-stack.md |  |
| document | implemented | Trading Logic (Compatibility Stub) | docs/architecture/archive/trading-logic.md |  |
| document | implemented | AI Assistant foundation chain | docs/architecture/chains/CHAIN-AI-ASSISTANT-FOUNDATION.md |  |
| document | implemented | API platform safety chain | docs/architecture/chains/CHAIN-API-PLATFORM-SAFETY.md |  |
| document | implemented | API support routes chain | docs/architecture/chains/CHAIN-API-SUPPORT-ROUTES.md |  |
| document | implemented | Auth session deep chain | docs/architecture/chains/CHAIN-AUTH-SESSION-DEEP.md |  |
| document | implemented | Auth session login chain | docs/architecture/chains/CHAIN-AUTH-SESSION.md |  |
| document | implemented | Backtest run lifecycle and replay chain | docs/architecture/chains/CHAIN-BACKTESTS.md |  |
| document | implemented | Bot Runtime monitoring core chain | docs/architecture/chains/CHAIN-BOT-RUNTIME-CORE.md |  |
| document | implemented | Bot setup and canonical topology chain | docs/architecture/chains/CHAIN-BOT-SETUP.md |  |
| document | implemented | Dashboard runtime monitoring chain | docs/architecture/chains/CHAIN-DASHBOARD-RUNTIME.md |  |
| document | implemented | Engine runtime core chain | docs/architecture/chains/CHAIN-ENGINE-RUNTIME-CORE.md |  |
| document | implemented | Exchange adapter deep capability and connector chain | docs/architecture/chains/CHAIN-EXCHANGE-ADAPTER-DEEP.md |  |
| document | implemented | Logs Audit Trail evidence chain | docs/architecture/chains/CHAIN-LOGS-AUDIT.md |  |
| document | implemented | Manual order deep execution chain | docs/architecture/chains/CHAIN-MANUAL-ORDER-DEEP.md |  |
| document | implemented | Manual order execution chain | docs/architecture/chains/CHAIN-MANUAL-ORDER.md |  |
| document | implemented | Market data and stream adapters chain | docs/architecture/chains/CHAIN-MARKET-DATA-STREAM-ADAPTERS.md |  |
| document | implemented | Market universe authoring and catalog chain | docs/architecture/chains/CHAIN-MARKETS.md |  |
| document | implemented | Operations config and pipeline chain | docs/architecture/chains/CHAIN-OPS-CONFIG-PIPELINE.md |  |
| document | implemented | Positions read reconciliation and manual update chain | docs/architecture/chains/CHAIN-POSITIONS-CORE.md |  |
| document | implemented | Profile API Keys credential lifecycle chain | docs/architecture/chains/CHAIN-PROFILE-API-KEYS.md |  |
| document | blocked | Release audit tooling evidence chain | docs/architecture/chains/CHAIN-RELEASE-AUDIT-TOOLING.md |  |
| document | implemented | Reports performance evidence chain | docs/architecture/chains/CHAIN-REPORTS.md |  |
| document | implemented | Runtime DCA exchange PnL chain | docs/architecture/chains/CHAIN-RUNTIME-DCA-PNL.md |  |
| document | implemented | Runtime support services chain | docs/architecture/chains/CHAIN-RUNTIME-SUPPORT-SERVICES.md |  |
| document | implemented | Strategy authoring and indicator catalog chain | docs/architecture/chains/CHAIN-STRATEGIES.md |  |
| document | implemented | Subscriptions Admin entitlement and management chain | docs/architecture/chains/CHAIN-SUBSCRIPTIONS-ADMIN.md |  |
| document | implemented | Wallets core lifecycle and analytics chain | docs/architecture/chains/CHAIN-WALLETS-CORE.md |  |
| document | implemented | Web runtime surfaces chain | docs/architecture/chains/CHAIN-WEB-RUNTIME-SURFACES.md |  |
| document | implemented | Function Chains | docs/architecture/chains/README.md |  |
| document | implemented | Codebase Map | docs/architecture/codebase-map.md |  |
| document | implemented | Data Ownership Map | docs/architecture/data-ownership-map.md |  |
| document | implemented | AI Red Team agent | docs/architecture/nodes/SOAR-AGENT-AI-RED-TEAM.md |  |
| document | implemented | Coordinator agent workflow | docs/architecture/nodes/SOAR-AGENT-COORDINATOR.md |  |
| document | implemented | PUT /admin/subscriptions/plans/:code | docs/architecture/nodes/SOAR-API-ADMIN-SUBSCRIPTION-PLAN-UPDATE.md |  |
| document | implemented | GET /admin/subscriptions/plans | docs/architecture/nodes/SOAR-API-ADMIN-SUBSCRIPTION-PLANS-LIST.md |  |
| document | implemented | GET /admin/users | docs/architecture/nodes/SOAR-API-ADMIN-USERS-LIST.md |  |
| document | implemented | PATCH /admin/users/:userId | docs/architecture/nodes/SOAR-API-ADMIN-USERS-UPDATE.md |  |
| document | implemented | POST /auth/login | docs/architecture/nodes/SOAR-API-AUTH-LOGIN.md |  |
| document | implemented | POST /auth/logout | docs/architecture/nodes/SOAR-API-AUTH-LOGOUT.md |  |
| document | implemented | GET /auth/me | docs/architecture/nodes/SOAR-API-AUTH-ME.md |  |
| document | implemented | POST /auth/register | docs/architecture/nodes/SOAR-API-AUTH-REGISTER.md |  |
| document | implemented | POST /dashboard/backtests/runs | docs/architecture/nodes/SOAR-API-BACKTEST-RUN-CREATE.md |  |
| document | implemented | DELETE /dashboard/backtests/runs/:id | docs/architecture/nodes/SOAR-API-BACKTEST-RUN-DELETE.md |  |
| document | implemented | GET /dashboard/backtests/runs/:id | docs/architecture/nodes/SOAR-API-BACKTEST-RUN-GET.md |  |
| document | implemented | GET /dashboard/backtests/runs | docs/architecture/nodes/SOAR-API-BACKTEST-RUN-LIST.md |  |
| document | implemented | GET /dashboard/backtests/runs/:id/report | docs/architecture/nodes/SOAR-API-BACKTEST-RUN-REPORT.md |  |
| document | implemented | GET /dashboard/backtests/runs/:id/timeline | docs/architecture/nodes/SOAR-API-BACKTEST-RUN-TIMELINE.md |  |
| document | implemented | GET /dashboard/backtests/runs/:id/trades | docs/architecture/nodes/SOAR-API-BACKTEST-RUN-TRADES.md |  |
| document | implemented | GET /dashboard/bots/:id/assistant-config | docs/architecture/nodes/SOAR-API-BOT-ASSISTANT-CONFIG-GET.md |  |
| document | implemented | PUT /dashboard/bots/:id/assistant-config | docs/architecture/nodes/SOAR-API-BOT-ASSISTANT-CONFIG-UPSERT.md |  |
| document | implemented | POST /dashboard/bots/:id/assistant-config/dry-run | docs/architecture/nodes/SOAR-API-BOT-ASSISTANT-DRY-RUN.md |  |
| document | implemented | POST /dashboard/bots | docs/architecture/nodes/SOAR-API-BOT-CREATE.md |  |
| document | implemented | DELETE /dashboard/bots/:id | docs/architecture/nodes/SOAR-API-BOT-DELETE.md |  |
| document | implemented | GET /dashboard/bots/:id | docs/architecture/nodes/SOAR-API-BOT-GET.md |  |
| document | implemented | GET /dashboard/bots | docs/architecture/nodes/SOAR-API-BOT-LIST.md |  |
| document | implemented | POST /dashboard/bots/:id/market-groups | docs/architecture/nodes/SOAR-API-BOT-MARKET-GROUP-CREATE.md |  |
| document | implemented | POST /dashboard/bots/:id/market-groups/:groupId/strategies | docs/architecture/nodes/SOAR-API-BOT-MARKET-GROUP-STRATEGY-ATTACH.md |  |
| document | implemented | GET /dashboard/bots/:id/market-groups | docs/architecture/nodes/SOAR-API-BOT-MARKET-GROUPS-LIST.md |  |
| document | implemented | GET /dashboard/bots/:id/runtime-monitoring/aggregate | docs/architecture/nodes/SOAR-API-BOT-RUNTIME-AGGREGATE.md |  |
| document | implemented | POST /dashboard/bots/:id/runtime-sessions/:sessionId/positions/:positionId/close | docs/architecture/nodes/SOAR-API-BOT-RUNTIME-CLOSE-POSITION.md |  |
| document | implemented | GET /dashboard/bots/:id/runtime-graph | docs/architecture/nodes/SOAR-API-BOT-RUNTIME-GRAPH.md |  |
| document | implemented | GET bot runtime positions | docs/architecture/nodes/SOAR-API-BOT-RUNTIME-POSITIONS.md |  |
| document | implemented | GET /dashboard/bots/:id/runtime-sessions/:sessionId | docs/architecture/nodes/SOAR-API-BOT-RUNTIME-SESSION-GET.md |  |
| document | implemented | GET /dashboard/bots/:id/runtime-sessions | docs/architecture/nodes/SOAR-API-BOT-RUNTIME-SESSIONS.md |  |
| document | implemented | GET /dashboard/bots/:id/runtime-sessions/:sessionId/symbol-stats | docs/architecture/nodes/SOAR-API-BOT-RUNTIME-SYMBOL-STATS.md |  |
| document | implemented | GET /dashboard/bots/:id/runtime-sessions/:sessionId/trades | docs/architecture/nodes/SOAR-API-BOT-RUNTIME-TRADES.md |  |
| document | implemented | DELETE /dashboard/bots/:id/assistant-config/subagents/:slotIndex | docs/architecture/nodes/SOAR-API-BOT-SUBAGENT-DELETE.md |  |
| document | implemented | PUT /dashboard/bots/:id/assistant-config/subagents/:slotIndex | docs/architecture/nodes/SOAR-API-BOT-SUBAGENT-UPSERT.md |  |
| document | implemented | PUT /dashboard/bots/:id | docs/architecture/nodes/SOAR-API-BOT-UPDATE.md |  |
| document | implemented | GET /dashboard/icons/lookup | docs/architecture/nodes/SOAR-API-ICON-LOOKUP.md |  |
| document | implemented | GET /dashboard/logs | docs/architecture/nodes/SOAR-API-LOGS-LIST.md |  |
| document | implemented | GET /dashboard/orders/manual-context | docs/architecture/nodes/SOAR-API-MANUAL-CONTEXT.md |  |
| document | implemented | GET /dashboard/markets/catalog | docs/architecture/nodes/SOAR-API-MARKET-CATALOG.md |  |
| document | implemented | GET /dashboard/market-stream/events | docs/architecture/nodes/SOAR-API-MARKET-STREAM-EVENTS.md |  |
| document | implemented | POST /dashboard/markets/universes | docs/architecture/nodes/SOAR-API-MARKET-UNIVERSE-CREATE.md |  |
| document | blocked | DELETE /dashboard/markets/universes/:id | docs/architecture/nodes/SOAR-API-MARKET-UNIVERSE-DELETE.md |  |
| document | implemented | GET /dashboard/markets/universes/:id | docs/architecture/nodes/SOAR-API-MARKET-UNIVERSE-GET.md |  |
| document | implemented | GET /dashboard/markets/universes | docs/architecture/nodes/SOAR-API-MARKET-UNIVERSE-LIST.md |  |
| document | blocked | PUT /dashboard/markets/universes/:id | docs/architecture/nodes/SOAR-API-MARKET-UNIVERSE-UPDATE.md |  |
| document | implemented | POST /dashboard/orders/:id/cancel | docs/architecture/nodes/SOAR-API-ORDER-CANCEL.md |  |
| document | implemented | POST /dashboard/orders/:id/close | docs/architecture/nodes/SOAR-API-ORDER-CLOSE.md |  |
| document | implemented | GET /dashboard/orders/:id | docs/architecture/nodes/SOAR-API-ORDER-GET.md |  |
| document | implemented | GET /dashboard/orders | docs/architecture/nodes/SOAR-API-ORDER-LIST.md |  |
| document | implemented | POST /dashboard/orders/open | docs/architecture/nodes/SOAR-API-ORDER-OPEN.md |  |
| document | implemented | GET /dashboard/positions/exchange-snapshot | docs/architecture/nodes/SOAR-API-POSITION-EXCHANGE-SNAPSHOT.md |  |
| document | implemented | GET /dashboard/positions/:id | docs/architecture/nodes/SOAR-API-POSITION-GET.md |  |
| document | implemented | GET /dashboard/positions | docs/architecture/nodes/SOAR-API-POSITION-LIST.md |  |
| document | implemented | GET /dashboard/positions/live-status | docs/architecture/nodes/SOAR-API-POSITION-LIVE-STATUS.md |  |
| document | implemented | PATCH /dashboard/positions/:id/management-mode | docs/architecture/nodes/SOAR-API-POSITION-MANAGEMENT-MODE.md |  |
| document | implemented | PATCH /dashboard/positions/:id/manual-update | docs/architecture/nodes/SOAR-API-POSITION-MANUAL-UPDATE.md |  |
| document | implemented | POST /dashboard/positions/orphan-repair | docs/architecture/nodes/SOAR-API-POSITION-ORPHAN-REPAIR.md |  |
| document | implemented | POST /dashboard/positions/takeover-rebind | docs/architecture/nodes/SOAR-API-POSITION-TAKEOVER-REBIND.md |  |
| document | implemented | GET /dashboard/positions/takeover-status | docs/architecture/nodes/SOAR-API-POSITION-TAKEOVER-STATUS.md |  |
| document | implemented | POST /dashboard/profile/apiKeys | docs/architecture/nodes/SOAR-API-PROFILE-APIKEY-CREATE.md |  |
| document | implemented | DELETE /dashboard/profile/apiKeys/:id | docs/architecture/nodes/SOAR-API-PROFILE-APIKEY-DELETE.md |  |
| document | implemented | GET /dashboard/profile/apiKeys | docs/architecture/nodes/SOAR-API-PROFILE-APIKEY-LIST.md |  |
| document | implemented | POST /dashboard/profile/apiKeys/:id/revoke | docs/architecture/nodes/SOAR-API-PROFILE-APIKEY-REVOKE.md |  |
| document | implemented | POST /dashboard/profile/apiKeys/:id/rotate | docs/architecture/nodes/SOAR-API-PROFILE-APIKEY-ROTATE.md |  |
| document | implemented | POST /dashboard/profile/apiKeys/:id/test | docs/architecture/nodes/SOAR-API-PROFILE-APIKEY-STORED-TEST.md |  |
| document | implemented | POST /dashboard/profile/apiKeys/test | docs/architecture/nodes/SOAR-API-PROFILE-APIKEY-TEST.md |  |
| document | implemented | PATCH /dashboard/profile/apiKeys/:id | docs/architecture/nodes/SOAR-API-PROFILE-APIKEY-UPDATE.md |  |
| document | implemented | DELETE /dashboard/profile/basic | docs/architecture/nodes/SOAR-API-PROFILE-BASIC-DELETE.md |  |
| document | implemented | GET /dashboard/profile/basic | docs/architecture/nodes/SOAR-API-PROFILE-BASIC-GET.md |  |
| document | implemented | PATCH /dashboard/profile/basic | docs/architecture/nodes/SOAR-API-PROFILE-BASIC-UPDATE.md |  |
| document | implemented | DELETE /dashboard/profile/security/account | docs/architecture/nodes/SOAR-API-PROFILE-SECURITY-ACCOUNT.md |  |
| document | implemented | PATCH /dashboard/profile/security/password | docs/architecture/nodes/SOAR-API-PROFILE-SECURITY-PASSWORD.md |  |
| document | implemented | POST /dashboard/profile/subscription/checkout-intents | docs/architecture/nodes/SOAR-API-PROFILE-SUBSCRIPTION-CHECKOUT.md |  |
| document | implemented | GET /dashboard/profile/subscription | docs/architecture/nodes/SOAR-API-PROFILE-SUBSCRIPTION-GET.md |  |
| document | implemented | GET /dashboard/reports/cross-mode-performance | docs/architecture/nodes/SOAR-API-REPORTS-CROSS-MODE-PERFORMANCE.md |  |
| document | implemented | POST /dashboard/strategies | docs/architecture/nodes/SOAR-API-STRATEGY-CREATE.md |  |
| document | blocked | DELETE /dashboard/strategies/:id | docs/architecture/nodes/SOAR-API-STRATEGY-DELETE.md |  |
| document | implemented | GET /dashboard/strategies/:id/export | docs/architecture/nodes/SOAR-API-STRATEGY-EXPORT.md |  |
| document | implemented | GET /dashboard/strategies/:id | docs/architecture/nodes/SOAR-API-STRATEGY-GET.md |  |
| document | implemented | POST /dashboard/strategies/import | docs/architecture/nodes/SOAR-API-STRATEGY-IMPORT.md |  |
| document | implemented | GET /dashboard/strategies/indicators | docs/architecture/nodes/SOAR-API-STRATEGY-INDICATORS.md |  |
| document | implemented | GET /dashboard/strategies | docs/architecture/nodes/SOAR-API-STRATEGY-LIST.md |  |
| document | blocked | PUT /dashboard/strategies/:id | docs/architecture/nodes/SOAR-API-STRATEGY-UPDATE.md |  |
| document | implemented | POST /upload/avatar | docs/architecture/nodes/SOAR-API-UPLOAD-AVATAR.md |  |
| document | implemented | GET /dashboard/wallets/:id/cashflow-events | docs/architecture/nodes/SOAR-API-WALLET-CASHFLOW-EVENTS.md |  |
| document | implemented | POST /dashboard/wallets | docs/architecture/nodes/SOAR-API-WALLET-CREATE.md |  |

## Relation Index

| Type | From | To | Evidence |
| --- | --- | --- | --- |
| connected_to | api_endpoint:delete-account:f30b50c3ea | module:apps-api-src:3261657fad | apps/api/src/modules/profile/security/security.routes.ts |
| connected_to | api_endpoint:delete-api-id:78dca92807 | module:apps-web-src:cde25d2b80 | apps/web/src/features/profile/services/apiKeys.service.ts |
| connected_to | api_endpoint:delete-dashboard-backtests-runs-runid:4abbef10c2 | module:apps-web-src:cde25d2b80 | apps/web/src/features/backtest/services/backtests.service.ts |
| connected_to | api_endpoint:delete-dashboard-bots-botid-assistant-config-subagents-slotindex:ae913a7a40 | module:apps-web-src:cde25d2b80 | apps/web/src/features/bots/services/bots.service.ts |
| connected_to | api_endpoint:delete-dashboard-bots-id:575b1cc463 | module:apps-web-src:cde25d2b80 | apps/web/src/features/bots/services/bots.service.ts |
| connected_to | api_endpoint:delete-dashboard-markets-universes-id:e785873139 | module:apps-web-src:cde25d2b80 | apps/web/src/features/markets/services/markets.service.ts |
| connected_to | api_endpoint:delete-dashboard-profile-security-account:03edce2513 | module:apps-web-src:cde25d2b80 | apps/web/src/features/profile/services/security.service.ts |
| connected_to | api_endpoint:delete-dashboard-strategies-id:45a4362b64 | module:apps-web-src:cde25d2b80 | apps/web/src/features/strategies/api/strategies.api.ts |
| connected_to | api_endpoint:delete-dashboard-wallets-id:8d272a4cd6 | module:apps-web-src:cde25d2b80 | apps/web/src/features/wallets/services/wallets.service.ts |
| connected_to | api_endpoint:delete-id-assistant-config-subagents-slotindex:0ffc379713 | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:delete-id-market-groups-groupid-strategies-linkid:5b7c95966e | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:delete-id-market-groups-groupid:cac0149411 | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:delete-id:7739bc0570 | module:apps-api-src:3261657fad | apps/api/src/modules/strategies/strategies.routes.ts |
| connected_to | api_endpoint:delete-id:7dde13e2ad | module:apps-api-src:3261657fad | apps/api/src/modules/wallets/wallets.routes.ts |
| connected_to | api_endpoint:delete-id:8b81ac92a5 | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:delete-runs-id:a5f5613802 | module:apps-api-src:3261657fad | apps/api/src/modules/backtests/backtests.routes.ts |
| connected_to | api_endpoint:delete-session:363e0f60bf | module:apps-web-src:cde25d2b80 | apps/web/src/context/AuthContext.tsx |
| connected_to | api_endpoint:delete-universes-id:b9dfbd3cf5 | module:apps-api-src:3261657fad | apps/api/src/modules/markets/markets.routes.ts |
| connected_to | api_endpoint:get-alerts:1897f480e5 | module:apps-api-src:3261657fad | apps/api/src/router/index.ts |
| connected_to | api_endpoint:get-auth-me:2cea817a78 | module:apps-web-src:cde25d2b80 | apps/web/src/ui/layout/dashboard/SafetyBar.tsx |
| connected_to | api_endpoint:get-auth-me:2da8364fc2 | module:apps-web-src:cde25d2b80 | apps/web/src/context/AuthContext.tsx |
| connected_to | api_endpoint:get-backuprestoredrill:039a3d6430 | module:scripts:356acdec23 | scripts/runV1FinalPreflight.mjs |
| connected_to | api_endpoint:get-cache-control:5ffe08fa54 | module:scripts:356acdec23 | scripts/runProdSecurityExchangeProof.mjs |
| connected_to | api_endpoint:get-catalog:ff5c1dd7d7 | module:apps-api-src:3261657fad | apps/api/src/modules/markets/markets.routes.ts |
| connected_to | api_endpoint:get-content-type:f4a5c4c7b0 | module:scripts:356acdec23 | scripts/deploySmokeCheck.mjs |
| connected_to | api_endpoint:get-cookie:90e70d689c | module:apps-web-src:cde25d2b80 | apps/web/src/middleware.ts |
| connected_to | api_endpoint:get-cross-mode-performance:87fe9c105a | module:apps-api-src:3261657fad | apps/api/src/modules/reports/reports.routes.ts |
| connected_to | api_endpoint:get-events:4326fda7cb | module:apps-api-src:3261657fad | apps/api/src/modules/market-stream/marketStream.routes.ts |
| connected_to | api_endpoint:get-exchange-snapshot:fd4a778e47 | module:apps-api-src:3261657fad | apps/api/src/modules/positions/positions.routes.ts |
| connected_to | api_endpoint:get-health:ba01ef0056 | module:apps-api-src:3261657fad | apps/api/src/router/index.ts |
| connected_to | api_endpoint:get-id-assistant-config:61b4d49199 | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:get-id-cashflow-events:80753e838c | module:apps-api-src:3261657fad | apps/api/src/modules/wallets/wallets.routes.ts |
| connected_to | api_endpoint:get-id-equity-timeline:c1cf7b3ab2 | module:apps-api-src:3261657fad | apps/api/src/modules/wallets/wallets.routes.ts |
| connected_to | api_endpoint:get-id-export:6483932b20 | module:apps-api-src:3261657fad | apps/api/src/modules/strategies/strategies.routes.ts |
| connected_to | api_endpoint:get-id-market-groups-groupid-strategies:38bcac2ef2 | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:get-id-market-groups-groupid:b1f4d19a94 | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:get-id-market-groups:b436180119 | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:get-id-performance-summary:344a4177da | module:apps-api-src:3261657fad | apps/api/src/modules/wallets/wallets.routes.ts |
| connected_to | api_endpoint:get-id-portfolio-history:048205c315 | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:get-id-runtime-graph:bdbed139cf | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:get-id-runtime-monitoring-aggregate:d45aa08315 | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:get-id-runtime-sessions-sessionid-positions:706c9141b0 | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:get-id-runtime-sessions-sessionid-symbol-stats:1aa47be0be | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:get-id-runtime-sessions-sessionid-trades:a8e30d20b6 | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:get-id-runtime-sessions-sessionid:098acb98fb | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:get-id-runtime-sessions:855929f8d4 | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:get-id:19adef2e0a | module:apps-api-src:3261657fad | apps/api/src/modules/strategies/strategies.routes.ts |
| connected_to | api_endpoint:get-id:49e1f76a10 | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:get-id:726c01895e | module:apps-api-src:3261657fad | apps/api/src/modules/positions/positions.routes.ts |
| connected_to | api_endpoint:get-id:e92be12cc2 | module:apps-api-src:3261657fad | apps/api/src/modules/wallets/wallets.routes.ts |
| connected_to | api_endpoint:get-id:ea5e0a0a73 | module:apps-api-src:3261657fad | apps/api/src/modules/orders/orders.routes.ts |
| connected_to | api_endpoint:get-live-status:41f61417a7 | module:apps-api-src:3261657fad | apps/api/src/modules/positions/positions.routes.ts |
| connected_to | api_endpoint:get-location:d243f6a127 | module:scripts:356acdec23 | scripts/runProdUiModuleClickthroughAudit.mjs |
| connected_to | api_endpoint:get-lookup:62811de576 | module:apps-api-src:3261657fad | apps/api/src/modules/icons/icons.routes.ts |
| connected_to | api_endpoint:get-manual-context:8f4f8707e9 | module:apps-api-src:3261657fad | apps/api/src/modules/orders/orders.routes.ts |
| connected_to | api_endpoint:get-market-cachekey:eb920016f8 | module:apps-api-src:3261657fad | apps/api/src/modules/market-data/marketData.service.ts |
| connected_to | api_endpoint:get-me:6a7167adbd | module:apps-api-src:3261657fad | apps/api/src/modules/auth/auth.routes.ts |
| connected_to | api_endpoint:get-metadata:5bdcdf53f0 | module:apps-api-src:3261657fad | apps/api/src/modules/wallets/wallets.routes.ts |
| connected_to | api_endpoint:get-metrics:c8c3bc223e | module:apps-api-src:3261657fad | apps/api/src/router/index.ts |
| connected_to | api_endpoint:get-pragma:4b0dbebd34 | module:scripts:356acdec23 | scripts/runProdSecurityExchangeProof.mjs |
| connected_to | api_endpoint:get-production:00357b8bfa | module:scripts:356acdec23 | scripts/buildSloWindowReport.mjs |
...
| connected_to | api_endpoint:get-runs-id-report:142bcab707 | module:apps-api-src:3261657fad | apps/api/src/modules/backtests/backtests.routes.ts |
| connected_to | api_endpoint:get-runs-id-timeline:d2e3c442fa | module:apps-api-src:3261657fad | apps/api/src/modules/backtests/backtests.routes.ts |
| connected_to | api_endpoint:get-runs-id-trades:16de2c3c36 | module:apps-api-src:3261657fad | apps/api/src/modules/backtests/backtests.routes.ts |
| connected_to | api_endpoint:get-runs-id:aa85080328 | module:apps-api-src:3261657fad | apps/api/src/modules/backtests/backtests.routes.ts |
| connected_to | api_endpoint:get-runs:12338d4e8a | module:apps-api-src:3261657fad | apps/api/src/modules/backtests/backtests.routes.ts |
| connected_to | api_endpoint:get-session:095f68a774 | module:apps-web-src:cde25d2b80 | apps/web/src/context/AuthContext.tsx |
| connected_to | api_endpoint:get-strategy-drift:8404885d2a | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:get-takeover-status:ce2adbef63 | module:apps-api-src:3261657fad | apps/api/src/modules/positions/positions.routes.ts |
| connected_to | api_endpoint:get-universes-id:f51affb919 | module:apps-api-src:3261657fad | apps/api/src/modules/markets/markets.routes.ts |
| connected_to | api_endpoint:get-universes:9a32226d42 | module:apps-api-src:3261657fad | apps/api/src/modules/markets/markets.routes.ts |
...
| connected_to | api_endpoint:get-x-content-type-options:94f67d88f4 | module:scripts:356acdec23 | scripts/runProdSecurityExchangeProof.mjs |
| connected_to | api_endpoint:get-x-frame-options:e7a53577e0 | module:scripts:356acdec23 | scripts/runProdSecurityExchangeProof.mjs |
| connected_to | api_endpoint:get:1f75b583ca | module:apps-api-src:3261657fad | apps/api/src/router/dashboard.routes.ts |
| connected_to | api_endpoint:get:41e06d4cc2 | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:get:6708703663 | module:apps-api-src:3261657fad | apps/api/src/router/admin.routes.ts |
| connected_to | api_endpoint:get:8215e9ee83 | module:apps-api-src:3261657fad | apps/api/src/modules/orders/orders.routes.ts |
| connected_to | api_endpoint:get:93eee4f851 | module:apps-api-src:3261657fad | apps/api/src/modules/wallets/wallets.routes.ts |
| connected_to | api_endpoint:get:be383ec167 | module:apps-api-src:3261657fad | apps/api/src/modules/admin/users/users.routes.ts |
| connected_to | api_endpoint:get:c47750c9b2 | module:apps-api-src:3261657fad | apps/api/src/modules/profile/subscription/subscription.routes.ts |
| connected_to | api_endpoint:get:d7f5a03ab2 | module:apps-api-src:3261657fad | apps/api/src/modules/logs/logs.routes.ts |
| connected_to | api_endpoint:get:e289a951eb | module:apps-api-src:3261657fad | apps/api/src/modules/admin/subscriptionPlans/subscriptionPlans.routes.ts |
| connected_to | api_endpoint:get:e56cba92b9 | module:apps-api-src:3261657fad | apps/api/src/modules/positions/positions.routes.ts |
| connected_to | api_endpoint:get:eadac08199 | module:apps-api-src:3261657fad | apps/api/src/modules/strategies/strategies.routes.ts |
| connected_to | api_endpoint:get:ec3f1b71d9 | module:apps-api-src:3261657fad | apps/api/src/router/index.ts |
| connected_to | api_endpoint:patch-dashboard-profile-security-password:0157444776 | module:apps-web-src:cde25d2b80 | apps/web/src/features/profile/services/security.service.ts |
| connected_to | api_endpoint:patch-id-management-mode:033b8e2075 | module:apps-api-src:3261657fad | apps/api/src/modules/positions/positions.routes.ts |
| connected_to | api_endpoint:patch-id-manual-update:f9dda43323 | module:apps-api-src:3261657fad | apps/api/src/modules/positions/positions.routes.ts |
| connected_to | api_endpoint:patch-password:689e6d98d6 | module:apps-api-src:3261657fad | apps/api/src/modules/profile/security/security.routes.ts |
| connected_to | api_endpoint:patch-userid:f2fe7bad13 | module:apps-api-src:3261657fad | apps/api/src/modules/admin/users/users.routes.ts |
| connected_to | api_endpoint:post-api-id-test:8a2df5723f | module:apps-web-src:cde25d2b80 | apps/web/src/features/profile/services/apiKeys.service.ts |
| connected_to | api_endpoint:post-api-test:a50ca70d58 | module:apps-web-src:cde25d2b80 | apps/web/src/features/profile/services/apiKeys.service.ts |
| connected_to | api_endpoint:post-auth-login:90b6d74dcf | module:apps-web-src:cde25d2b80 | apps/web/src/features/auth/services/auth.service.ts |
| connected_to | api_endpoint:post-auth-logout:4e8f58100e | module:apps-web-src:cde25d2b80 | apps/web/src/context/AuthContext.tsx |
| connected_to | api_endpoint:post-auth-register:5629d4d568 | module:apps-web-src:cde25d2b80 | apps/web/src/features/auth/services/auth.service.ts |
| connected_to | api_endpoint:post-auth-register:a26c300f90 | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.e2e.shared.ts |
| connected_to | api_endpoint:post-avatar:7fc11e575e | module:apps-api-src:3261657fad | apps/api/src/modules/upload/upload.routes.ts |
| connected_to | api_endpoint:post-checkout-intents:69a724078d | module:apps-api-src:3261657fad | apps/api/src/modules/profile/subscription/subscription.routes.ts |
| connected_to | api_endpoint:post-dashboard-strategies:0af0ebef32 | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.e2e.shared.ts |
| connected_to | api_endpoint:post-id-assistant-config-dry-run:3208a5385e | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:post-id-cancel:4f0807b404 | module:apps-api-src:3261657fad | apps/api/src/modules/orders/orders.routes.ts |
| connected_to | api_endpoint:post-id-close:421ec390b1 | module:apps-api-src:3261657fad | apps/api/src/modules/orders/orders.routes.ts |
| connected_to | api_endpoint:post-id-market-groups-groupid-strategies:e6015c693b | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:post-id-market-groups:c58f39e188 | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:post-id-reset-paper:3e02217f27 | module:apps-api-src:3261657fad | apps/api/src/modules/wallets/wallets.routes.ts |
| connected_to | api_endpoint:post-id-revoke:e7e2387be7 | module:apps-api-src:3261657fad | apps/api/src/modules/profile/apiKey/apiKey.routes.ts |
| connected_to | api_endpoint:post-id-rotate:3f481c1b83 | module:apps-api-src:3261657fad | apps/api/src/modules/profile/apiKey/apiKey.routes.ts |
| connected_to | api_endpoint:post-id-runtime-sessions-sessionid-positions-positionid-close:d15be61060 | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:post-id-test:89710894b5 | module:apps-api-src:3261657fad | apps/api/src/modules/profile/apiKey/apiKey.routes.ts |
| connected_to | api_endpoint:post-import:38e0272f32 | module:apps-api-src:3261657fad | apps/api/src/modules/strategies/strategies.routes.ts |
...
| connected_to | api_endpoint:post-open:acca6acb50 | module:apps-api-src:3261657fad | apps/api/src/modules/orders/orders.routes.ts |
| connected_to | api_endpoint:post-orphan-repair:19a9125e9a | module:apps-api-src:3261657fad | apps/api/src/modules/positions/positions.routes.ts |
| connected_to | api_endpoint:post-preview-balance:125997f212 | module:apps-api-src:3261657fad | apps/api/src/modules/wallets/wallets.routes.ts |
...
| connected_to | api_endpoint:post-runs:b5c7c73179 | module:apps-api-src:3261657fad | apps/api/src/modules/backtests/backtests.routes.ts |
| connected_to | api_endpoint:post-strategy-drift-repair:0d8f851aee | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:post-takeover-rebind:eba31d82a7 | module:apps-api-src:3261657fad | apps/api/src/modules/positions/positions.routes.ts |
| connected_to | api_endpoint:post-test:ffd8ffe6cb | module:apps-api-src:3261657fad | apps/api/src/modules/profile/apiKey/apiKey.routes.ts |
| connected_to | api_endpoint:post-universes:d76216b131 | module:apps-api-src:3261657fad | apps/api/src/modules/markets/markets.routes.ts |
| connected_to | api_endpoint:post-upload-avatar:725a663b30 | module:apps-web-src:cde25d2b80 | apps/web/src/features/profile/components/BasicForm.tsx |
| connected_to | api_endpoint:post:157b0d2c13 | module:apps-api-src:3261657fad | apps/api/src/modules/wallets/wallets.routes.ts |
| connected_to | api_endpoint:post:3c025b48a5 | module:apps-api-src:3261657fad | apps/api/src/modules/strategies/strategies.routes.ts |
| connected_to | api_endpoint:post:fa2c14ae20 | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:put-code:ef26fdee7a | module:apps-api-src:3261657fad | apps/api/src/modules/admin/subscriptionPlans/subscriptionPlans.routes.ts |
| connected_to | api_endpoint:put-id-assistant-config-subagents-slotindex:b1736ae97c | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:put-id-assistant-config:87a38ce548 | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:put-id-market-groups-groupid-strategies-linkid:7a7bdabe3c | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:put-id-market-groups-groupid-strategies-reorder:2d6eccb973 | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:put-id-market-groups-groupid:ba71db3cc3 | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:put-id:1671eda59a | module:apps-api-src:3261657fad | apps/api/src/modules/bots/bots.routes.ts |
| connected_to | api_endpoint:put-id:8db9d07bf0 | module:apps-api-src:3261657fad | apps/api/src/modules/strategies/strategies.routes.ts |
| connected_to | api_endpoint:put-id:9ca7d23f6a | module:apps-api-src:3261657fad | apps/api/src/modules/wallets/wallets.routes.ts |
| connected_to | api_endpoint:put-universes-id:ab3d95f8c7 | module:apps-api-src:3261657fad | apps/api/src/modules/markets/markets.routes.ts |
| connected_to | api_endpoint:route-id:41f2dbfbf8 | module:apps-api-src:3261657fad | apps/api/src/modules/profile/apiKey/apiKey.routes.ts |
| connected_to | api_endpoint:route:06e9366fa7 | module:apps-api-src:3261657fad | apps/api/src/modules/strategies/indicators/indicators.routes.ts |
| connected_to | api_endpoint:route:1f8355a8bc | module:apps-api-src:3261657fad | apps/api/src/modules/profile/basic/basic.routes.ts |
| connected_to | api_endpoint:route:aa7e32820e | module:apps-api-src:3261657fad | apps/api/src/modules/profile/apiKey/apiKey.routes.ts |
...
| connected_to | api_endpoint:use-indicators:e391d4b773 | module:apps-api-src:3261657fad | apps/api/src/modules/strategies/strategies.routes.ts |
...
| connected_to | project:soar:7c70e892d7 | task:project-state:24389d0ee8 | .codex/context/PROJECT_STATE.md |
...
| documents | agent:ai-red-team-agent:905092e07a | module:codex:b484af535d | .codex/agents/ai-red-team-agent.md |
| documents | agent:anti-regression-system:c99df5ca5f | module:agents:703799f003 | .agents/core/anti-regression.md |
| documents | agent:backend-builder-agent:877dc683f5 | module:claude:919c47e63e | .claude/agents/backend-builder.agent.md |
...
| documents | agent:db-migrations-agent:95840cfdeb | module:claude:919c47e63e | .claude/agents/db-migrations.agent.md |