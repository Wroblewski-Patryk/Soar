...
8. [Module registry](./modules/module-registry.md)
9. [Architecture overview and principles](./architecture/01_overview-and-principles.md)
10. [System topology](./architecture/02_system-topology.md)
11. [Domain model](./architecture/03_domain-model.md)
12. [Runtime contexts](./architecture/04_runtime-contexts.md)
13. [Strategy, signal, and decision flow](./architecture/05_strategy-signal-and-decision-flow.md)
14. [Execution lifecycle](./architecture/06_execution-lifecycle.md)
15. [Modes, parity, and data](./architecture/07_modes-parity-and-data.md)
16. [Operator surfaces and routing](./architecture/08_operator-surfaces-and-routing.md)
17. [Integrations, deployment, and runtime services](./architecture/09_integrations-deployment-and-runtime-services.md)
18. [Safety, entitlements, and risk](./architecture/10_safety-entitlements-and-risk.md)
19. [Assistant runtime](./architecture/11_assistant-runtime.md)
20. [Documentation governance](./architecture/12_documentation-governance.md)
21. [System modules](./modules/system-modules.md)
22. [MVP execution plan](./planning/mvp-execution-plan.md)
23. [MVP next commits](./planning/mvp-next-commits.md)
24. [Open decisions](./planning/open-decisions.md)
