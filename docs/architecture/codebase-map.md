...
| exchanges | `apps/web/src/features/exchanges` | `/dashboard/exchanges` redirect/context UI | `docs/modules/web-exchanges.md` |
...
- Dashboard: `/dashboard`, `/dashboard/exchanges`, `/dashboard/profile`,
