---
id: SOAR-API-PROFILE-APIKEY-CREATE
name: "POST /dashboard/profile/apiKeys"
type: api_route
...
| Field | Value |
| --- | --- |
| Description | Authenticated API-key create endpoint with encrypted credential storage. |
...
| Children |  |
| Depends on | [[SOAR-CONTROLLER-PROFILE-API-KEYS]], [[SOAR-TYPES-PROFILE-API-KEYS]], [[SOAR-SERVICE-PROFILE-API-KEYS]] |
| Used by | [[SOAR-SERVICE-WEB-API-KEYS]], [[SOAR-FEATURE-WALLETS]] |
| UI related |  |
| API related | [[SOAR-API-PROFILE-APIKEY-LIST]] |
| Database related | [[SOAR-DB-API-KEY]], [[SOAR-DB-USER]], [[SOAR-DB-LOG]] |
| Tests related | [[SOAR-TEST-PROFILE-API-KEYS-API]] |
| Docs related | [[SOAR-DOC-API-PROFILE]] |
| Agent related |  |
| Notes | Stores encrypted credentials and audit-safe lifecycle metadata. |
